...
public class TEBellows extends NetworkTileEntity {
    ...
    public void giveAir() {
        ...
        if (worldObj.blockExists(xCoord + x, yCoord, zCoord + z)) {
            ...
            if (te instanceof TEFireEntity) tileentityfirepit = (TEFireEntity) te;
            else if (te2 instanceof TEForge) tileentityfirepit = (TEFireEntity) te2;

            if (tileentityfirepit != null) tileentityfirepit.receiveAirFromBellows();
        }
    }
