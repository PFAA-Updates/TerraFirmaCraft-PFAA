...
public class TFC_OreDictionary {
    ...
    public static void registerOreDict() {
        ...
        for (Item axe : Recipes.axes) OreDictionary.registerOre("itemAxe", new ItemStack(axe, 1, WILD));
        ...
        for (Item chisel : Recipes.chisels) OreDictionary.registerOre("itemChisel", new ItemStack(chisel, 1, WILD));
        ...
        for (Item hammer : Recipes.hammers) OreDictionary.registerOre("itemHammer", new ItemStack(hammer, 1, WILD));
        ...
        for (Item knife : Recipes.knives) OreDictionary.registerOre("itemKnife", new ItemStack(knife, 1, WILD));
        ...
        for (Item saw : Recipes.saws) OreDictionary.registerOre("itemSaw", new ItemStack(saw, 1, WILD));
        ...
        for (Item scythe : Recipes.scythes) OreDictionary.registerOre("itemScythe", new ItemStack(scythe, 1, WILD));
        ...
        for (Item pick : Recipes.picks) OreDictionary.registerOre("itemPick", new ItemStack(pick, 1, WILD));
        ...
        for (Item proPick : Recipes.proPicks) OreDictionary.registerOre("itemProPick", new ItemStack(proPick, 1, WILD));
        ...
        for (Item shovel : Recipes.shovels) OreDictionary.registerOre("itemShovel", new ItemStack(shovel, 1, WILD));
        ...
        for (Item hoe : Recipes.hoes) OreDictionary.registerOre("itemHoe", new ItemStack(hoe, 1, WILD));
        ...
        for (Item sword : Recipes.swords) OreDictionary.registerOre("itemSword", new ItemStack(sword, 1, WILD));
        ...
        for (Item mace : Recipes.maces) OreDictionary.registerOre("itemMace", new ItemStack(mace, 1, WILD));
        ...
        for (Item javelin : Recipes.javelins) OreDictionary.registerOre("itemJavelin", new ItemStack(javelin, 1, WILD));
        ...
        // Seed Bags
        for (Item seed : Recipes.seeds) OreDictionary.registerOre("seedBag", new ItemStack(seed, 1, WILD));
