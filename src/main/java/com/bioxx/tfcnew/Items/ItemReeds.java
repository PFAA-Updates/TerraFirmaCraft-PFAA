...
public class ItemReeds extends Item {
     ...
     */
    @Override
    public boolean onItemUse(ItemStack is, EntityPlayer player, World world, int x, int y, int z, int side, float par8,
            ...
            if (world.canPlaceEntityOnSide(this.reeds, x, y, z, false, side, (Entity) null, is)) {
                ...
                if (world.setBlock(x, y, z, this.reeds, i1, 3)) {
                    ...
                    world.playSoundEffect(
                        ...
                        y + 0.5F,
                        z + 0.5F,
                        this.reeds.stepSound.func_150496_b(),
                        (this.reeds.stepSound.getVolume() + 1.0F) / 2.0F,
                        this.reeds.stepSound.getPitch() * 0.8F);
                    --is.stackSize;
                }
            }
            return true;
