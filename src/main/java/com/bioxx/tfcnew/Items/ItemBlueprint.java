...
public class ItemBlueprint extends ItemTerra {
    ...
    public String getItemStackDisplayName(ItemStack is) {
        ...
        else return TFC_Core.translate(this.getUnlocalizedName());
    }
    ...
    public void addExtraInformation(ItemStack is, EntityPlayer player, List<String> arraylist) {
        if (TFC_Core.showShiftInformation()) {
            ...
            if (is.hasTagCompound() && !is.stackTagCompound.getString(ItemBlueprint.TAG_ITEM_NAME)
                .isEmpty()) arraylist.add(TFC_Core.translate("gui.Blueprint.Inst1"));
        } else {
