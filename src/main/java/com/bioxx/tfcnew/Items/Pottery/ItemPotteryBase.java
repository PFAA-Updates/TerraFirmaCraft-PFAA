...
public class ItemPotteryBase extends ItemTerra implements ISize {
    ...
    public void getSubItems(Item par1, CreativeTabs par2CreativeTabs, List list) {
        for (int i = 0; i < metaNames.length; i++) list.add(new ItemStack(this, 1, i));
    }
        ...
        if (!world.isRemote && entityplayer.isSneaking()) {
            ...
            if (side == 1) {
                ...
                if (world.getBlock(x, y, z) != TFCBlocks.pottery && world.isAirBlock(x, y + 1, z)) {
                    ...
                    if (!world.isSideSolid(x, y, z, ForgeDirection.UP)) return false;
                ...
                if (world.getTileEntity(x, y + offset, z) != null
                    ...
                    } else if (hitX > 0.5 && hitZ > 0.5) if (te.canAddItem(3)) {
