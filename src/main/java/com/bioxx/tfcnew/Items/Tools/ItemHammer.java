...
public class ItemHammer extends ItemTerraTool implements ICausesDamage {
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (id2 == TFCBlocks.stoneIgEx || id2 == TFCBlocks.stoneIgIn) {
            if (side == 1) {
                ...
                if (te == null) world.setTileEntity(x, y, z, new TEAnvil());
                if (te != null) {
    ...
    public boolean onBlockDestroyed(ItemStack stack, EntityPlayer player, World world, int i, int j, int k, int side,
        EntityLiving entity) {
        return false;
    }
    ...
    public Multimap getAttributeModifiers(ItemStack is) {
        ...
        multimap.put(
            ...
            new AttributeModifier(field_111210_e, "Tool modifier", getWeaponDamage(is), 0));
        return multimap;
    }
