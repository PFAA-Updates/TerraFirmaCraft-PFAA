...
public class FloraManager {
    ...
    static {
        ...
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[1],
                TFC_Time.APRIL,
                TFC_Time.MAY,
                TFC_Time.SEPTEMBER,
                TFC_Time.SEPTEMBER,
                new ItemStack(TFCItems.banana, 1)));
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[2],
                TFC_Time.FEBRUARY,
                TFC_Time.APRIL,
                TFC_Time.NOVEMBER,
                TFC_Time.NOVEMBER,
        ...
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[4],
                TFC_Time.MAY,
                TFC_Time.JUNE,
                TFC_Time.AUGUST,
                TFC_Time.AUGUST,
                new ItemStack(TFCItems.lemon, 1)));
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[5],
                TFC_Time.JUNE,
                TFC_Time.JUNE,
                TFC_Time.OCTOBER,
                TFC_Time.OCTOBER,
                new ItemStack(TFCItems.olive, 1)));
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[6],
                TFC_Time.APRIL,
                TFC_Time.APRIL,
                TFC_Time.JUNE,
                TFC_Time.JUNE,
                new ItemStack(TFCItems.cherry, 1)));
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[7],
                TFC_Time.APRIL,
                TFC_Time.MAY,
                TFC_Time.SEPTEMBER,
                TFC_Time.SEPTEMBER,
                new ItemStack(TFCItems.peach, 1)));
        INSTANCE.addIndex(
            new FloraIndex(
                Global.FRUIT_META_NAMES[8],
                TFC_Time.MAY,
                TFC_Time.JUNE,
                TFC_Time.JULY,
                TFC_Time.AUGUST,
                new ItemStack(TFCItems.plum, 1)));
        ...
        INSTANCE.addIndex(
            new FloraIndex(
                ...
                TFC_Time.SEPTEMBER,
                TFC_Time.OCTOBER,
                new ItemStack(TFCItems.wintergreenBerry, 1)).setHangTime(5)
                    .setTemp(-18, 28)
                    .setBioTemp(0, 20)
                    .setRain(500, 4000)
                    .setEVT(0f, 1));
