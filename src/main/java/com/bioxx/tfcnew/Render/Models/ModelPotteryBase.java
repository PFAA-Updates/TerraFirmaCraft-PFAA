...
public class ModelPotteryBase extends ModelBox {
    ...
    public ModelPotteryBase(ModelRenderer renderer, int textureOffsetX, int textureOffsetY, float originX,
        float originY, float originZ, int width, int height, int depth, float scale, Object[] dataArray,
        boolean connectTop) {
         ...
         * textureOffsetY + depth + height, renderer.textureWidth, renderer.textureHeight);
         * this.quadList[1] = new TexturedQuad(new PositionTextureVertex[] {vert0, vert4, vert7, vert3},
         * textureOffsetX, textureOffsetY + depth, textureOffsetX + depth, textureOffsetY + depth + height,
         ...
         * textureOffsetX + depth, textureOffsetY, textureOffsetX + depth + width, textureOffsetY + depth,
         * renderer.textureWidth, renderer.textureHeight);
         * this.quadList[3] = new TexturedQuad(new PositionTextureVertex[] {vert2, vert3, vert7, vert6},
         * textureOffsetX + depth + width, textureOffsetY + depth, textureOffsetX + depth + width + width,
         * textureOffsetY, renderer.textureWidth, renderer.textureHeight);
         ...
         * height, renderer.textureWidth, renderer.textureHeight);
         ...
         * width, textureOffsetY + depth + height, renderer.textureWidth, renderer.textureHeight);
         */
    ...
    public PositionTextureVertex[] newRing(float originX, float originY, float originZ, float offsetX, float offsetY,
        float offsetZ, float width) {
        PositionTextureVertex[] vert = new PositionTextureVertex[8];
        float widthX = width / (MathHelper.sqrt_float(2) + 2);
        vert[0] = new PositionTextureVertex(
            originX + offsetX - (width / 2) - widthX,
            originY + offsetY,
            originZ + offsetZ - (width / 2f),
            0,
            0);
        vert[1] = new PositionTextureVertex(
            originX + offsetX + (width / 2) - widthX,
            originY + offsetY,
            originZ + offsetZ - (width / 2f),
            0,
            0);
        vert[2] = new PositionTextureVertex(
            originX + offsetX + (width / 2f),
            originY + offsetY,
            originZ + offsetZ - (width / 2) - widthX,
            0,
            0);
        vert[3] = new PositionTextureVertex(
            originX + offsetX + (width / 2f),
            originY + offsetY,
            originZ + offsetZ + (width / 2) - widthX,
            0,
            0);
        vert[4] = new PositionTextureVertex(
            originX + offsetX + (width / 2) - widthX,
            originY + offsetY,
            originZ + offsetZ + (width / 2f),
            0,
            0);
        vert[5] = new PositionTextureVertex(
            originX + offsetX - (width / 2) - widthX,
            originY + offsetY,
            originZ + offsetZ + (width / 2f),
            0,
            0);
        vert[6] = new PositionTextureVertex(
            originX + offsetX - (width / 2f),
            originY + offsetY,
            originZ + offsetZ + (width / 2) - widthX,
            0,
            0);
        vert[7] = new PositionTextureVertex(
            originX + offsetX - (width / 2f),
            originY + offsetY,
            originZ + offsetZ - (width / 2) - widthX,
            0,
    ...
    public List<TexturedQuad> buildSides(Object[] vertices, ModelRenderer renderer, int textureOffsetX,
        int textureOffsetY, float originX, float originY, float originZ, int width, int height, int depth, float scale,
        boolean connectTopFace) {
        ...
        for (int i = 0; i < vertices.length - 1; i++) {
            for (int j = 0; j < 8; j++) {
                aList.add(
                    new TexturedQuad(
                        new PositionTextureVertex[] { ((PositionTextureVertex[]) (vertices[i + 1]))[j],
                            ((PositionTextureVertex[]) (vertices[i + 1]))[(j + 1) % 8],
                            ((PositionTextureVertex[]) (vertices[i]))[(j + 1) % 8],
                            ((PositionTextureVertex[]) (vertices[i]))[j] },
