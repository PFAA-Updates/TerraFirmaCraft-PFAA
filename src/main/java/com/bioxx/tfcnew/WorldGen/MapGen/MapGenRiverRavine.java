...
public class MapGenRiverRavine extends MapGenBaseTFC {
    ...
    protected void generateRavine(long seed, int chunkX, int chunkZ, Block[] blockArray, double par6, double startY,
        double par10, float par12, float par13, float par14, int par15, int par16, double par17, double waterHeight) {
        ...
        for (int var28 = 0; var28 < 256; ++var28) {
            if (var28 == 0 || rand.nextInt(3) == 0) var27 = 1.0F + rand.nextFloat() * rand.nextFloat() * 1.0F;
        ...
        for (; par15 < par16; ++par15) {
            ...
            if (var54 || rand.nextInt(4) != 0)// <--Determines the length of the ravine
            {
                ...
                if (par6 >= worldX - 16.0D - var53 * 2.0D && par10 >= worldZ - 16.0D - var53 * 2.0D
                    && par6 <= worldX + 16.0D + var53 * 2.0D
                    && par10 <= worldZ + 16.0D + var53 * 2.0D) {
                        ...
                        for (int var42 = var57; !var58 && var42 < var39; ++var42) {
                            for (int var43 = var37 + 1; !var58 && var43 >= var55 - 1; --var43) {
                                ...
                                if (var43 >= 0 && var43 < 256) {
                                    if (var43 != var55 - 1 && x != var56
                                        && x != var35 - 1
                                        && var42 != var57
                                        && var42 != var39 - 1) var43 = var55;
                                }
                            }
                        }
                    }
