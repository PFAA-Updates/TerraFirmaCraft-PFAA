    ...
    public boolean generate(World world, Random rand, int xCoord, int yCoord, int zCoord) {
        ...
        if (yCoord >= 1 && yCoord + var6 + 1 <= 256) {
            ...
            for (blockUnder = yCoord; blockUnder <= yCoord + 1 + var6; ++blockUnder) {
                byte var9 = 2;
                if (blockUnder == yCoord) var9 = 1;
                if (blockUnder >= yCoord + 1 + var6 - 2) var9 = 2;
            ...
            if (!canGenHere) {
                ...
                if (TFC_Core.isSoil(world.getBlock(xCoord, yCoord - 1, zCoord)) && yCoord < 256 - var6 - 1) {
                    ...
                    world.setBlock(
                        ...
                        yCoord - 1,
                        zCoord,
                        TFC_Core.getTypeForDirt(rockLayer1.data2),
                        TFC_Core.getSoilMetaFromStone(rockLayer1.block, rockLayer1.data2),
                        0x2);
                    world.setBlock(
                        xCoord + 1,
                        yCoord - 1,
                    ...
                    for (int var14 = yCoord + var6 - 2 - rand.nextInt(4); var14
                        > yCoord + var6 / 2; var14 -= 2 + rand.nextInt(4)) {
                    ...
                    for (tempX = 0; tempX < var6; ++tempX) {
                        ...
                        if (id.isAir(world, xCoord, yCoord + tempX, zCoord) || id == TFCBlocks.leaves
                            || id == TFCBlocks.leaves2) {
                            this.setBlockAndNotifyAdequately(
                                world,
                                xCoord,
                                yCoord + tempX,
