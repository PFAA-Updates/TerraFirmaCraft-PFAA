...
public class TFCWorldChunkManager extends WorldChunkManager {
    ...
    public TFCWorldChunkManager(long genSeed, WorldType worldtype) {
        ...
        GenLayerTFC[] var4;
        if (worldtype == TFCWorldType.flatWorldType) var4 = GenLayerTFC.initialize(genSeed, TFCWorldType.flatWorldType);
        else var4 = GenLayerTFC.initialize(genSeed, TFCWorldType.defaultWorldType);
    ...
    public float[] getRainfall(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5) {
        if (TFC_Climate.getCacheManager(worldObj) != null) return TFC_Climate.getCacheManager(worldObj)
            .getRainfall(par1ArrayOfFloat, par2, par3, par4, par5);
    ...
    public TFCBiome[] getBiomesForGeneration(BiomeGenBase[] par1, int par2, int par3, int par4, int par5) {
        ...
        if (biome == null || biome.length < par4 * par5) biome = new TFCBiome[par4 * par5];
