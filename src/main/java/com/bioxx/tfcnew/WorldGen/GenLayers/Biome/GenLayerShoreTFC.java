    ...
    public int[] getInts(int par1, int par2, int par3, int par4) {
        ...
        for (int var7 = 0; var7 < par4; ++var7) {
            for (int var8 = 0; var8 < par3; ++var8) {
                ...
                if (!TFC_Core.isOceanicBiome(var9) && var9 != TFCBiome.RIVER.biomeID
                    && var9 != TFCBiome.SWAMPLAND.biomeID
                    && var9 != TFCBiome.HIGH_HILLS.biomeID) {
                    ...
                    if (!TFC_Core.isOceanicBiome(var10) && !TFC_Core.isOceanicBiome(var11)
                        && !TFC_Core.isOceanicBiome(var12)
                        && !TFC_Core.isOceanicBiome(var13)) var6[var8 + var7 * par3] = var9;
                    else {
                        int beachid = TFCBiome.BEACH.biomeID;
                        if (TFC_Core.isMountainBiome(var9)) beachid = TFCBiome.GRAVEL_BEACH.biomeID;
