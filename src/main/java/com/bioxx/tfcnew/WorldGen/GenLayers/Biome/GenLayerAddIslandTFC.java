        ...
        for (int var11 = 0; var11 < par4; ++var11) {
            for (int var12 = 0; var12 < par3; ++var12) {
                ...
                if (var17 == 0 && (var13 != 0 || var14 != 0 || var15 != 0 || var16 != 0)) {
                    ...
                    if (var13 != 0 && this.nextInt(var18++) == 0) var19 = var13;

                    if (var14 != 0 && this.nextInt(var18++) == 0) var19 = var14;

                    if (var15 != 0 && this.nextInt(var18++) == 0) var19 = var15;

                    if (var16 != 0 && this.nextInt(var18++) == 0) var19 = var16;

                    if (this.nextInt(3) == 0) var10[var12 + var11 * par3] = var19;
                    else var10[var12 + var11 * par3] = 0;
                } else if (var17 > 0 && (var13 == 0 || var14 == 0 || var15 == 0 || var16 == 0)) {
                    if (this.nextInt(5) == 0) var10[var12 + var11 * par3] = 0;
                    else var10[var12 + var11 * par3] = var17;
                } else {
