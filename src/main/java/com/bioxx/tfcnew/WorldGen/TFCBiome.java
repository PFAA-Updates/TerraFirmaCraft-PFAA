...
public class TFCBiome extends BiomeGenBase {
    ...
    public static final TFCBiome OCEAN = new TFCBiome(0).setBiomeName("Ocean")
        .setMinMaxHeight(-0.9F, 0.00001F)
        .setBiomeColor(0x0000ff);
    public static final TFCBiome RIVER = new TFCBiome(7).setBiomeName("River")
        .setMinMaxHeight(riverDepthMin, riverDepthMax)
        .setBiomeColor(0xffffff);
    public static final TFCBiome HELL = new TFCBiome(8).setColor(16711680)
        .setBiomeName("Hell")
        .setDisableRain()
        .setTemperatureRainfall(2.0F, 0.0F);
    public static final TFCBiome BEACH = new TFCBiome(16).setColor(0xfade55)
        .setBiomeName("Beach")
        .setMinMaxHeight(0.01F, 0.02F)
        .setBiomeColor(0xffb873);
    public static final TFCBiome GRAVEL_BEACH = new TFCBiome(17).setColor(0xfade55)
        .setBiomeName("Gravel Beach")
        .setMinMaxHeight(0.01F, 0.02F)
        .setBiomeColor(0x8f7963);
    public static final TFCBiome HIGH_HILLS = new TFCBiome(3).setBiomeName("High Hills")
        .setMinMaxHeight(0.8F, 1.6F)
        .setBiomeColor(0x044f27);
    public static final TFCBiome PLAINS = new TFCBiome(1).setBiomeName("Plains")
        .setMinMaxHeight(0.1F, 0.16F)
        .setBiomeColor(0x69dfa0);
    public static final TFCBiome SWAMPLAND = new TFCBiome(6).setBiomeName("Swamp")
        .setMinMaxHeight(-0.1F, 0.1F)
        .setBiomeColor(0x1f392b)
        .setLilyPads(8)
        .setWaterPlants(45);
    public static final TFCBiome HIGH_HILLS_EDGE = new TFCBiome(20).setBiomeName("High Hills Edge")
        .setMinMaxHeight(0.2F, 0.4F)
        .setBiomeColor(0x30a767);
    public static final TFCBiome ROLLING_HILLS = new TFCBiome(30).setBiomeName("Rolling Hills")
        .setMinMaxHeight(0.1F, 0.4F)
        .setBiomeColor(0x87b434);
    public static final TFCBiome MOUNTAINS = new TFCBiome(31).setBiomeName("Mountains")
        .setMinMaxHeight(0.8F, 1.6F)
    ...
    public static final TFCBiome MOUNTAINS_EDGE = new TFCBiome(32).setBiomeName("Mountains Edge")
        ...
        .setBiomeColor(0xb2bc9f);
    public static final TFCBiome HIGH_PLAINS = new TFCBiome(35).setBiomeName("High Plains")
        .setMinMaxHeight(0.4F, 0.43F)
        .setBiomeColor(0xa6a41c);
    public static final TFCBiome DEEP_OCEAN = new TFCBiome(36).setBiomeName("Deep Ocean")
        .setMinMaxHeight(-1.5F, 0.00001F)
        .setBiomeColor(0x0e055a);
    public static final TFCBiome LAKE = new TFCBiome(2).setBiomeName("Lake")
        .setMinMaxHeight(-0.5F, 0.001F)
        .setBiomeColor(0x4a8e9e)
        .setLilyPads(2);
    ...
    public static WorldGenerator getTreeGen(int i, Boolean j) {
        ...
        switch (i) {
            case 7: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 7) : worldGenAshTallTrees;
                else return worldGenAshShortTrees;
            }
            case 1: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 1) : worldGenAspenTallTrees;
                else return worldGenAspenShortTrees;
            }
            case 2: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 2) : worldGenBirchTallTrees;
                else return worldGenBirchShortTrees;
            }
            case 3: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 3) : worldGenChestnutTallTrees;
                else return worldGenChestnutShortTrees;
            }
            case 4: {
                if (j) return worldGenDouglasFirTallTrees;
                else return worldGenDouglasFirShortTrees;
            }
            case 5: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 5) : worldGenHickoryTallTrees;
                else return worldGenHickoryShortTrees;
            }
            case 6: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 6) : worldGenMapleTallTrees;
                else return worldGenMapleShortTrees;
            }
            case 0: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 0) : worldGenOakTallTrees;
                else return worldGenOakShortTrees;
            }
            case 8: {
                if (j) return worldGenPineTallTrees;
                else return worldGenPineShortTrees;
            }
            case 9: {
                if (j) return worldGenRedwoodTallTrees;
                else return worldGenRedwoodShortTrees;
            }
            case 10: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 10) : worldGenSpruceTallTrees;
                else return worldGenSpruceShortTrees;
            }
            case 11: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 11) : worldGenSycamoreTallTrees;
                else return worldGenSycamoreShortTrees;
            }
            case 12: {
                return worldGenWhiteCedarTallTrees;
            }
            case 13: {
                if (j) return r.nextInt(20) == 0 ? new WorldGenCustomBigTree(false, 13) : worldGenWhiteElmTallTrees;
                else return worldGenWhiteElmShortTrees;
            }
            case 14: {
    ...
    public static TFCBiome getBiomeByName(String name) {
        for (int i = 0; i < getBiomeGenArray().length; i++) {
            if (getBiomeGenArray()[i] != null) {
                ...
                if (n.equalsIgnoreCase(name)) return getBiomeGenArray()[i];
            }
        }
        return null;
    }
