...
public class EntityCowTFC extends EntityCow implements IAnimal {
    ...
    public boolean interact(EntityPlayer player) {
        if (!worldObj.isRemote) {
            ...
            if (getGender() == GenderEnum.FEMALE && isAdult()
                && hasMilkTime < TFC_Time.getTotalTicks()
                && this.checkFamiliarity(InteractionEnum.MILK, player)) {
        ...
        if (itemstack != null && this.isBreedingItemTFC(itemstack)
            && this.checkFamiliarity(InteractionEnum.BREED, player)
    ...
    public void onLivingUpdate() {
        ...
        if (getGender() == GenderEnum.FEMALE && isAdult()
            && hasMilkTime < TFC_Time.getTotalTicks()
            && this.checkFamiliarity(InteractionEnum.MILK, null)) canMilk = true;
        else canMilk = false;
