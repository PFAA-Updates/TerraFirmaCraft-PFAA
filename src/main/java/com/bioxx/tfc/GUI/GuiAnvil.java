...
public class GuiAnvil extends GuiContainerTFC {
    ...
    public static ResourceLocation texture = new ResourceLocation(
        Reference.MOD_ID,
        Reference.ASSET_PATH_GUI + "gui_anvil.png");
    ...
    public void initGui() {
        ...
        buttonList.add(
            new GuiAnvilButton(
                ...
                16,
                16,
                TFC_Textures.anvilShrink,
                208,
                17,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.Shrink")));
        buttonList.add(
            new GuiAnvilButton(
                6,
                guiLeft + 105,
                ...
                16,
                16,
                TFC_Textures.anvilUpset,
                208,
                17,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.Upset")));
        buttonList.add(
            new GuiAnvilButton(
                5,
                guiLeft + 123,
                ...
                16,
                16,
                TFC_Textures.anvilBend,
                208,
                17,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.Bend")));
        buttonList.add(
            new GuiAnvilButton(
                4,
                guiLeft + 105,
                ...
                16,
                16,
                TFC_Textures.anvilPunch,
                208,
                17,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.Punch")));
        buttonList.add(
            new GuiAnvilButton(
                3,
                guiLeft + 87,
                ...
                16,
                16,
                TFC_Textures.anvilDraw,
                208,
                33,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.Draw")));
        buttonList.add(
            new GuiAnvilButton(
                2,
                guiLeft + 69,
                ...
                16,
                16,
                TFC_Textures.anvilHitHeavy,
                208,
                33,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.HeavyHit")));
        buttonList.add(
            new GuiAnvilButton(
                1,
                guiLeft + 87,
                ...
                16,
                16,
                TFC_Textures.anvilHitMedium,
                208,
                33,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.MediumHit")));
        buttonList.add(
            new GuiAnvilButton(
                0,
                guiLeft + 69,
                ...
                16,
                16,
                TFC_Textures.anvilHitLight,
                208,
                33,
                16,
                16,
                this,
                TFC_Core.translate("gui.Anvil.LightHit")));
        ...
        buttonList.add(
            new GuiAnvilButton(
                ...
                this,
                2,
                TFCOptions.anvilRuleColor2[0],
                TFCOptions.anvilRuleColor2[1],
                TFCOptions.anvilRuleColor2[2]));
        buttonList.add(
            new GuiAnvilButton(
                10,
                guiLeft + 94,
                ...
                this,
                1,
                TFCOptions.anvilRuleColor1[0],
                TFCOptions.anvilRuleColor1[1],
                TFCOptions.anvilRuleColor1[2]));
        buttonList.add(
            new GuiAnvilButton(
                11,
                guiLeft + 75,
                ...
                this,
                0,
                TFCOptions.anvilRuleColor0[0],
                TFCOptions.anvilRuleColor0[1],
                TFCOptions.anvilRuleColor0[2]));
        buttonList.add(
            new GuiAnvilPlanButton(
                12,
                guiLeft + 122,
                guiTop + 45,
                18,
                18,
                this,
                TFC_Core.translate("gui.Anvil.Plans")));
    }
    ...
    public void updateScreen() {
        ...
        if (anvilTE != null) // Fixes NPE
        {
            ...
            if (craftingPlan != null && craftingPlan != plan || stack1 != null && stack1 != input
    ...
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.id == 0) anvilTE.actionLightHammer();
        else if (guibutton.id == 2) anvilTE.actionHeavyHammer();
        else if (guibutton.id == 1) anvilTE.actionHammer();
        else if (guibutton.id == 3) anvilTE.actionDraw();
        else if (guibutton.id == 4) anvilTE.actionPunch();
        else if (guibutton.id == 5) anvilTE.actionBend();
        else if (guibutton.id == 6) anvilTE.actionUpset();
        else if (guibutton.id == 7) anvilTE.actionShrink();
        else if (guibutton.id == 8) anvilTE.actionWeld();
    ...
    public void drawItemRulesImages(int w, int h) {
        if (anvilTE != null && anvilTE.itemCraftingRules != null) {
            ...
            if (rules != null && rules[0].matches(itemRules, 0)) GL11.glColor4f(0.0F, 1.0F, 0.0F, 1.0F);
            drawTexturedModalRect(w + 77, h + 28, 210, 115, 15, 15);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);

            if (rules != null && rules[1].matches(itemRules, 1)) GL11.glColor4f(0.0F, 1.0F, 0.0F, 1.0F);
            drawTexturedModalRect(w + 96, h + 28, 210, 115, 15, 15);
            GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);

            if (rules != null && rules[2].matches(itemRules, 2)) GL11.glColor4f(0.0F, 1.0F, 0.0F, 1.0F);
    ...
    public void drawRulesImages(int w, int h) {
        if (anvilTE.workRecipe != null) {
            ...
            GL11.glColor4ub(
                ...
                TFCOptions.anvilRuleColor0[2],
                (byte) 255);
            if (rules[0].Min == 0) drawTexturedModalRect(w + 75, h + 26, 228, 68, 19, 3);
            ...
            GL11.glColor4ub(
                ...
                TFCOptions.anvilRuleColor1[2],
                (byte) 255);
            if (rules[1].Min == 0) drawTexturedModalRect(w + 75, h + 24, 228, 68, 19, 3);
            ...
            GL11.glColor4ub(
                ...
                TFCOptions.anvilRuleColor2[2],
                (byte) 255);
            if (rules[2].Min == 0) drawTexturedModalRect(w + 75, h + 22, 228, 68, 19, 3);
    ...
    @Override
    protected boolean func_146978_c/* isPointInRegion */(int slotX, int slotY, int sizeX, int sizeY, int clickX,
        int clickY) {
        int k1 = this.guiLeft;
        int l1 = this.guiTop;
        clickX -= k1;
     ...
     */
    public void drawTexturedModalRect(int drawX, int drawY, int drawWidth, int drawHeight, int u, int v, int width,
        int height) {
        float f = 0.00390625F;
        ...
        tessellator
            .addVertexWithUV(drawX + drawWidth, drawY + drawHeight, this.zLevel, (u + width) * f, (v + height) * f1);
