...
public class GuiInventoryTFC extends InventoryEffectRenderer {
    ...
    protected static final ResourceLocation UPPER_TEXTURE = new ResourceLocation(
        Reference.MOD_ID + ":textures/gui/inventory.png");
    protected static final ResourceLocation UPPER_TEXTURE_2X2 = new ResourceLocation(
        Reference.MOD_ID + ":textures/gui/gui_inventory2x2.png");
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (player.getEntityData()
            .hasKey("craftingTable")) TFC_Core.bindTexture(UPPER_TEXTURE);
        else TFC_Core.bindTexture(UPPER_TEXTURE_2X2);
        int k = this.guiLeft;
        int l = this.guiTop;
    ...
    public void updateScreen() {
        if (this.mc.playerController.isInCreativeMode()) this.mc.displayGuiScreen(new GuiContainerCreativeTFC(player));
    }
    ...
    public void initGui() {
        ...
        if (!this.mc.thePlayer.getActivePotionEffects()
            .isEmpty()) {
        ...
        buttonList.add(
            new GuiInventoryButton(
                ...
                25,
                20,
                TFC_Core.translate("gui.Inventory.Inventory"),
                TFC_Textures.guiInventory));
        buttonList.add(
            new GuiInventoryButton(
                1,
                guiLeft + 176,
                ...
                25,
                20,
                TFC_Core.translate("gui.Inventory.Skills"),
                TFC_Textures.guiSkills));
        buttonList.add(
            new GuiInventoryButton(
                2,
                guiLeft + 176,
                ...
                25,
                20,
                TFC_Core.translate("gui.Calendar.Calendar"),
                TFC_Textures.guiCalendar));
        buttonList.add(
            new GuiInventoryButton(
                3,
                guiLeft + 176,
                ...
                25,
                20,
                TFC_Core.translate("gui.Inventory.Health"),
                TFC_Textures.guiHealth));
    }

    @Override
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.id == 1) Minecraft.getMinecraft()
            .displayGuiScreen(new GuiSkills(player));
        else if (guibutton.id == 2) Minecraft.getMinecraft()
            .displayGuiScreen(new GuiCalendar(player));
        else if (guibutton.id == 3) Minecraft.getMinecraft()
            .displayGuiScreen(new GuiHealth(player));
    }
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.xSizeLow = par1;
        this.ySizeLow = par2;
        if (hasEffect) displayDebuffEffects();

        for (int j1 = 0; j1 < this.inventorySlots.inventorySlots.size(); ++j1) {
            Slot slot = (Slot) this.inventorySlots.inventorySlots.get(j1);
            if (this.isMouseOverSlot(slot, par1, par2) && slot.func_111238_b()) this.activeSlot = slot;
        }
    }

    protected boolean isMouseOverSlot(Slot par1Slot, int par2, int par3) {
        return this.func_146978_c/* isPointInRegion */(
            par1Slot.xDisplayPosition,
            par1Slot.yDisplayPosition,
            16,
            16,
            par2,
            par3);
    ...
    private void displayDebuffEffects() {
        ...
        if (!var4.isEmpty()) {
            ...
            if (var4.size() > 5) var6 = 132 / (var4.size() - 1);

            for (Iterator var7 = this.mc.thePlayer.getActivePotionEffects()
                .iterator(); var7.hasNext(); var2 += var6) {
                ...
                if (var8.getAmplifier() == 1) var12 = var12 + " II";
                else if (var8.getAmplifier() == 2) var12 = var12 + " III";
                else if (var8.getAmplifier() == 3) var12 = var12 + " IV";
    ...
    protected boolean checkHotbarKeys(int keycode) {
        ...
        if (keycode == 31 && activeSlot != null
            ...
            for (int i = 9; i < 45 && getEmptyCraftSlot() != -1
                && knifeSlot != -1
                && inventorySlots.getSlot(knifeSlot)
                    .getStack() != null; i++) {
                ItemStack is = this.inventorySlots.getSlot(i)
                    .getStack();
                int knifeDamage = inventorySlots.getSlot(knifeSlot)
                    .getStack()
                    .getItemDamage();
                if (knifeDamage >= inventorySlots.getSlot(knifeSlot)
                    .getStack()
                    .getMaxDamage()) break;
    ...
    private int getEmptyCraftSlot() {
        if (this.inventorySlots.getSlot(4)
            .getStack() == null) return 4;
        if (this.inventorySlots.getSlot(1)
            .getStack() == null) return 1;
        if (this.inventorySlots.getSlot(2)
            .getStack() == null) return 2;
        if (this.inventorySlots.getSlot(3)
            .getStack() == null) return 3;
        if (player.getEntityData()
            .hasKey("craftingTable")) {
            if (this.inventorySlots.getSlot(45)
                .getStack() == null) return 45;
            if (this.inventorySlots.getSlot(46)
                .getStack() == null) return 46;
            if (this.inventorySlots.getSlot(47)
                .getStack() == null) return 47;
            if (this.inventorySlots.getSlot(48)
                .getStack() == null) return 48;
            if (this.inventorySlots.getSlot(49)
                .getStack() == null) return 49;
        }
    ...
    private boolean getCraftingHasKnife() {
        if (this.inventorySlots.getSlot(4)
            .getStack() != null
            && this.inventorySlots.getSlot(4)
                .getStack()
                .getItem() instanceof IKnife)
            return true;
        if (this.inventorySlots.getSlot(1)
            .getStack() != null
            && this.inventorySlots.getSlot(1)
                .getStack()
                .getItem() instanceof IKnife)
            return true;
        if (this.inventorySlots.getSlot(2)
            .getStack() != null
            && this.inventorySlots.getSlot(2)
                .getStack()
                .getItem() instanceof IKnife)
            return true;
        if (this.inventorySlots.getSlot(3)
            .getStack() != null
            && this.inventorySlots.getSlot(3)
                .getStack()
                .getItem() instanceof IKnife)
            return true;
        if (player.getEntityData()
            ...
            if (this.inventorySlots.getSlot(45)
                .getStack() != null
                && this.inventorySlots.getSlot(45)
                    .getStack()
                    .getItem() instanceof IKnife)
                return true;
            if (this.inventorySlots.getSlot(46)
                .getStack() != null
                && this.inventorySlots.getSlot(46)
                    .getStack()
                    .getItem() instanceof IKnife)
                return true;
            if (this.inventorySlots.getSlot(47)
                .getStack() != null
                && this.inventorySlots.getSlot(47)
                    .getStack()
                    .getItem() instanceof IKnife)
                return true;
            if (this.inventorySlots.getSlot(48)
                .getStack() != null
                && this.inventorySlots.getSlot(48)
                    .getStack()
                    .getItem() instanceof IKnife)
                return true;
            if (this.inventorySlots.getSlot(49)
                .getStack() != null
                && this.inventorySlots.getSlot(49)
                    .getStack()
                    .getItem() instanceof IKnife)
                return true;
        }
