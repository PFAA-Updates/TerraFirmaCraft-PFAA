...
public class GuiSluice extends GuiContainerTFC {
    ...
    public static ResourceLocation texture = new ResourceLocation(
        Reference.MOD_ID,
        Reference.ASSET_PATH_GUI + "gui_sluice.png");
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        if (sluiceTE.soilAmount != -1) fontRendererObj
            .drawString(TFC_Core.translate("gui.Sluice.Soil") + ": " + sluiceTE.soilAmount + "/50", 15, 39, 0x404040);
        else fontRendererObj.drawString(TFC_Core.translate("gui.Sluice.Overworked"), 10, 39, 0x404040);
    }
}
