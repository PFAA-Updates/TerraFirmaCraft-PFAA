...
public class GuiFoodPrep extends GuiContainerTFC {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(
        Reference.MOD_ID,
        Reference.ASSET_PATH_GUI + "gui_foodprep.png");
    ...
    public void initGui() {
        ...
        if (guiTab == 0) {
            buttonList.add(
                new GuiButton(0, guiLeft + 74, guiTop + 44, 50, 20, TFC_Core.translate("gui.FoodPrep.CreateMeal")));
            buttonList.add(
                new GuiFoodPrepTabButton(
                    2,
                    guiLeft + 36,
                    guiTop - 21,
                    31,
                    21,
                    this,
                    new ItemStack(TFCItems.salad),
                    TFC_Core.translate("gui.FoodPrep.Salad")).setButtonCoord(31, 172));
            buttonList.add(
                new GuiFoodPrepTabButton(
                    1,
                    guiLeft + 5,
                    ...
                    21,
                    this,
                    new ItemStack(TFCItems.sandwich),
                    TFC_Core.translate("gui.FoodPrep.Sandwich")));
        } else if (guiTab == 1) {
            buttonList.add(
                new GuiButton(0, guiLeft + 74, guiTop + 44, 50, 20, TFC_Core.translate("gui.FoodPrep.CreateMeal")));
            buttonList.add(
                new GuiFoodPrepTabButton(
                    ...
                    this,
                    new ItemStack(TFCItems.salad),
                    TFC_Core.translate("gui.FoodPrep.Salad")));
            buttonList.add(
                new GuiFoodPrepTabButton(
                    1,
                    guiLeft + 5,
                    ...
                    this,
                    new ItemStack(TFCItems.sandwich),
                    TFC_Core.translate("gui.FoodPrep.Sandwich")).setButtonCoord(31, 172));
        }
    }

    @Override
    protected void actionPerformed(GuiButton guibutton) {
        if (guibutton.id == 0) foodPrepTE.actionCreate(Minecraft.getMinecraft().thePlayer);
    ...
    public void updateScreen() {
        super.updateScreen();
        if (guiTab == 0 && foodPrepTE.validateSandwich()) ((GuiButton) buttonList.get(0)).enabled = true;
        else if (guiTab == 1 && foodPrepTE.validateSalad()) ((GuiButton) buttonList.get(0)).enabled = true;
        else if (((GuiButton) buttonList.get(0)).enabled) ((GuiButton) buttonList.get(0)).enabled = false;
    ...
    public class GuiFoodPrepTabButton extends GuiButton {
        ...
        public GuiFoodPrepTabButton(int index, int xPos, int yPos, int width, int height, GuiFoodPrep gui, ItemStack is,
            String s) {
        ...
        public GuiFoodPrepTabButton(int index, int xPos, int yPos, int width, int height, GuiFoodPrep gui, String s,
