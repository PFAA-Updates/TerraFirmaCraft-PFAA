...
public class GuiKnappingButton extends GuiButton {
    ...
    public void drawButton(Minecraft par1Minecraft, int xPos, int yPos) {
        if (this.visible) {
            ...
            if (pi.specialCraftingType != null) icon = pi.specialCraftingType.getIconIndex();
            ...
            // this.drawTexturedModalRect(this.xPosition + this.width / 2, this.yPosition, 200 - this.width / 2, 46 + k
