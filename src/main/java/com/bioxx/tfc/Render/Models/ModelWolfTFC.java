...
public class ModelWolfTFC extends ModelBase {
    ...
    public ModelWolfTFC() {
        ...
        this.wolfHeadMain.setTextureOffset(16, 14)
            .addBox(-3.0F, -5.0F, 0.0F, 2, 2, 1, f);
        this.wolfHeadMain.setTextureOffset(16, 14)
            .addBox(1.0F, -5.0F, 0.0F, 2, 2, 1, f);
        this.wolfHeadMain.setTextureOffset(0, 10)
            .addBox(-1.5F, 0.0F, -5.0F, 3, 3, 4, f);
    }
    ...
    public void setLivingAnimations(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4) {
        ...
        wolfTail.rotateAngleY = 0.5f * (1 - (1 / (entitywolf.getHappyTicks() + 1f)))
            * MathHelper.sin((float) (Math.PI * entitywolf.getHappyTicks() / 5F));
    }
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6,
        ...
        else this.wolfTail.rotateAngleX = par3;
    }
}
