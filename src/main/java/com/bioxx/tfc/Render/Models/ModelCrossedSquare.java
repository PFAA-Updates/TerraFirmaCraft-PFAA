...
public class ModelCrossedSquare extends ModelBox {
    ...
    public ModelCrossedSquare(ModelRenderer renderer, int textureOffsetX, int textureOffsetY, float originX,
        float originY, float originZ, int width, int height, int depth, float scale) {
        ...
        this.quadList[0] = new TexturedQuad(
            new PositionTextureVertex[] { vert3, vert6, vert5, vert0 },
        ...
        this.quadList[1] = new TexturedQuad(
            new PositionTextureVertex[] { vert2, vert7, vert4, vert1 },
        ...
        this.quadList[2] = new TexturedQuad(
            new PositionTextureVertex[] { vert6, vert3, vert0, vert5 },
            textureOffsetX + depth,
            textureOffsetY + depth,
            textureOffsetX + depth + width,
            textureOffsetY + depth + height,
        ...
        this.quadList[3] = new TexturedQuad(
            new PositionTextureVertex[] { vert7, vert2, vert1, vert4 },
            textureOffsetX + depth + width + depth,
            textureOffsetY + depth,
            textureOffsetX + depth + width + depth + width,
            textureOffsetY + depth + height,
