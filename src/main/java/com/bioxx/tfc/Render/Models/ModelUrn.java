...
public class ModelUrn extends ModelBox {
    ...
    public ModelUrn(ModelRenderer renderer, int textureOffsetX, int textureOffsetY, float originX, float originY,
        float originZ, int width, int height, int depth, float scale) {
        ...
        this.quadList[0] = new TexturedQuad(
            new PositionTextureVertex[] { vert7, vert6, vert2, vert3 },
        ...
        this.quadList[1] = new TexturedQuad(
            new PositionTextureVertex[] { vert5, vert7, vert3, vert1 },
            textureOffsetX,
            textureOffsetY + depth,
        ...
        this.quadList[2] = new TexturedQuad(
            new PositionTextureVertex[] { vert4, vert5, vert1, vert0 },
            textureOffsetX + depth,
            textureOffsetY,
            textureOffsetX + depth + width,
            textureOffsetY + depth,
        ...
        this.quadList[3] = new TexturedQuad(
            new PositionTextureVertex[] { vert6, vert4, vert0, vert2 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
        ...
        this.quadList[4] = new TexturedQuad(
            new PositionTextureVertex[] { vert1, vert0, vert2, vert3 },
            textureOffsetX + depth,
            textureOffsetY + depth,
            textureOffsetX + depth + width,
            textureOffsetY + depth + height,
        ...
        this.quadList[5] = new TexturedQuad(
            new PositionTextureVertex[] { vert11, vert10, vert6, vert7 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            textureOffsetX + depth + width + depth,
            textureOffsetY + depth + height,
        ...
        this.quadList[6] = new TexturedQuad(
            new PositionTextureVertex[] { vert9, vert11, vert7, vert5 },
            textureOffsetX,
            textureOffsetY + depth,
            textureOffsetX + depth,
            textureOffsetY + depth + height,
        ...
        this.quadList[7] = new TexturedQuad(
            new PositionTextureVertex[] { vert8, vert9, vert5, vert4 },
            textureOffsetX + depth,
            textureOffsetY,
            textureOffsetX + depth + width,
            textureOffsetY + depth,
        ...
        this.quadList[8] = new TexturedQuad(
            new PositionTextureVertex[] { vert10, vert8, vert4, vert6 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            textureOffsetX + depth + width + width,
            textureOffsetY,
        ...
        this.quadList[9] = new TexturedQuad(
            new PositionTextureVertex[] { vert15, vert14, vert10, vert11 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            textureOffsetX + depth + width + depth,
            textureOffsetY + depth + height,
        ...
        this.quadList[10] = new TexturedQuad(
            new PositionTextureVertex[] { vert13, vert15, vert11, vert9 },
            textureOffsetX,
            textureOffsetY + depth,
            textureOffsetX + depth,
            textureOffsetY + depth + height,
        ...
        this.quadList[11] = new TexturedQuad(
            new PositionTextureVertex[] { vert12, vert13, vert9, vert8 },
            textureOffsetX + depth,
            textureOffsetY,
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            renderer.textureWidth,
            renderer.textureHeight);
        this.quadList[12] = new TexturedQuad(
            new PositionTextureVertex[] { vert14, vert12, vert8, vert10 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            textureOffsetX + depth + width + width,
            textureOffsetY,
        ...
        this.quadList[13] = new TexturedQuad(
            new PositionTextureVertex[] { vert19, vert18, vert14, vert15 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            textureOffsetX + depth + width + depth,
            textureOffsetY + depth + height,
            renderer.textureWidth,
            renderer.textureHeight);
        this.quadList[14] = new TexturedQuad(
            new PositionTextureVertex[] { vert17, vert19, vert15, vert13 },
            textureOffsetX,
            textureOffsetY + depth,
            textureOffsetX + depth,
            textureOffsetY + depth + height,
            renderer.textureWidth,
            renderer.textureHeight);
        this.quadList[15] = new TexturedQuad(
            new PositionTextureVertex[] { vert16, vert17, vert13, vert12 },
            textureOffsetX + depth,
            textureOffsetY,
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            renderer.textureWidth,
            renderer.textureHeight);
        this.quadList[16] = new TexturedQuad(
            new PositionTextureVertex[] { vert18, vert16, vert12, vert14 },
            textureOffsetX + depth + width,
            textureOffsetY + depth,
            textureOffsetX + depth + width + width,
            textureOffsetY,
