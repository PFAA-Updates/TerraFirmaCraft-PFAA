    ...
    public boolean renderWorldBlock(IBlockAccess world, int par2, int par3, int par4, Block block, int modelId,
        ...
        if ((i1 == 2 || i1 == 0)
            && renderer.blockAccess
                .getBlock(par2 - 1, par3, par4) instanceof com.bioxx.tfc.Blocks.Vanilla.BlockCustomWall
            && renderer.blockAccess
                .getBlock(par2 + 1, par3, par4) instanceof com.bioxx.tfc.Blocks.Vanilla.BlockCustomWall
            || (i1 == 3 || i1 == 1)
                && renderer.blockAccess
                    .getBlock(par2, par3, par4 - 1) instanceof com.bioxx.tfc.Blocks.Vanilla.BlockCustomWall
                && renderer.blockAccess
                    .getBlock(par2, par3, par4 + 1) instanceof com.bioxx.tfc.Blocks.Vanilla.BlockCustomWall) {
            f -= 0.1875F;
            f1 -= 0.1875F;
        ...
        if (flag1) {
            if (i1 == 2 || i1 == 0) renderer.uvRotateTop = 1;
