...
public class RenderFence implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        if (par1BlockFence.canConnectFenceTo(renderblocks.blockAccess, x - 1, y, z)
            || par1BlockFence.canConnectFenceTo(renderblocks.blockAccess, x + 1, y, z)) flag1 = true;

        if (par1BlockFence.canConnectFenceTo(renderblocks.blockAccess, x, y, z - 1)
            || par1BlockFence.canConnectFenceTo(renderblocks.blockAccess, x, y, z + 1)) flag2 = true;
