...
public class RenderFlora {
    ...
    public static boolean render(Block block, int x, int y, int z, RenderBlocks renderer) {
        ...
        boolean hasAirTwoAbove = renderer.blockAccess.getBlock(x, y + 2, z)
            .isAir(renderer.blockAccess, x, y + 2, z);
    ...
    public static boolean renderShortWaterPlant(Block block, int x, int y, int z, RenderBlocks renderer,
        int plantType) {
