...
public class RenderPlayerTFC extends RenderPlayer {
    ...
    // private static final ResourceLocation RES_ITEM_GLINT = new
     ...
     */
    @Override
    protected int shouldRenderPass/* setArmorModel */(AbstractClientPlayer par1AbstractClientPlayer, int slotIndex,
        float partialTick) {
        ItemStack itemstack;
