...
public class RenderBlocksLightCache extends RenderBlocksFixUV {
    ...
    private static class RenderFaceData {
        ...
        public RenderPointData getCachedValue(double leftRight, double topBottom) {
            ...
            double highTop = (cacheBrightnessTopLeft >> 16 & 0xff) * leftRight
                + (1.0d - leftRight) * (cacheBrightnessTopRight >> 16 & 0xff);
            double highBottom = (cacheBrightnessBottomLeft >> 16 & 0xff) * leftRight
                + (1.0d - leftRight) * (cacheBrightnessBottomRight >> 16 & 0xff);
            int high = ((int) (highTop * topBottom + highBottom * (1.0d - topBottom))) & 0xff;

            double lowTop = (cacheBrightnessTopLeft & 0xff) * leftRight
                + (1.0d - leftRight) * (cacheBrightnessTopRight & 0xff);
            double lowBottom = (cacheBrightnessBottomLeft & 0xff) * leftRight
                + (1.0d - leftRight) * (cacheBrightnessBottomRight & 0xff);
