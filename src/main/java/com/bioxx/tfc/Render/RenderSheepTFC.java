...
public class RenderSheepTFC extends RenderSheep {
    ...
    private static final ResourceLocation SHEEP_FUR_TEXTURE = new ResourceLocation(
        "textures/entity/sheep/sheep_fur.png");
    private static final ResourceLocation SHEEP_TEXTURE = new ResourceLocation(
        Reference.MOD_ID,
    ...
    protected int setWoolColorAndRender(EntitySheepTFC par1EntitySheep, int par2, float par3) {
        if (par2 == 0 && !par1EntitySheep.getSheared()) {
            ...
            GL11.glColor3f(
                var4 * EntitySheepTFC.FLEECE_COLOR_TABLE[var5][0],
                var4 * EntitySheepTFC.FLEECE_COLOR_TABLE[var5][1],
                var4 * EntitySheepTFC.FLEECE_COLOR_TABLE[var5][2]);
            return 1;
        } else {
            return -1;
        }
