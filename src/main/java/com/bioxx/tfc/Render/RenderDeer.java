...
public class RenderDeer extends RenderLiving {
    ...
    private static final ResourceLocation DEER_TEXTURE = new ResourceLocation(
        Reference.MOD_ID,
        "textures/mob/deer.png");
    private static final ResourceLocation FAWN_TEXTURE = new ResourceLocation(
        Reference.MOD_ID,
        "textures/mob/deer_fawn.png");
    ...
    protected void preRenderScale(EntityDeer par1EntityDeer, float par2) {
        GL11.glScalef(
            par1EntityDeer.getSizeMod() - 0.3f,
            par1EntityDeer.getSizeMod() - 0.3f,
            par1EntityDeer.getSizeMod() - 0.3f);
    }
