...
public class RenderHorseTFC extends RenderHorse {
    ...
    private static final ResourceLocation ZOMBIE_TEXTURE = new ResourceLocation(
    ...
    protected void renderHorse(EntityHorse par1EntityHorse, float par2, float par3, float par4, float par5, float par6,
        float par7) {
    ...
    private ResourceLocation getTexture(EntityHorse par1EntityHorse) {
        ...
        if (resourcelocation == null) {
            ...
            Minecraft.getMinecraft()
                .getTextureManager()
                .loadTexture(resourcelocation, new LayeredTexture(par1EntityHorse.getVariantTexturePaths()));
     ...
     */
    @Override
    protected void renderModel(EntityLivingBase par1EntityLivingBase, float par2, float par3, float par4, float par5,
