...
public class TESRQuern extends TESRBase implements ISimpleBlockRenderingHandler {
    ...
    private static final ResourceLocation BASE_TEXTURE = new ResourceLocation(
        Reference.MOD_ID + ":textures/blocks/devices/Quern Base.png");
    private static final ResourceLocation TOP1_TEXTURE = new ResourceLocation(
        Reference.MOD_ID + ":textures/blocks/devices/Quern Top 1.png");
    private static final ResourceLocation TOP2_TEXTURE = new ResourceLocation(
        Reference.MOD_ID + ":textures/blocks/devices/Quern Top 2.png");
    private static final ResourceLocation WOOD_TEXTURE = new ResourceLocation(
        Reference.MOD_ID + ":textures/blocks/wood/Oak Plank.png");
    ...
    public void renderTileEntityAt(TileEntity te, double xDis, double yDis, double zDis, float f) {
        ...
        GL11.glPushMatrix();
        {
            ...
            if (teq.hasQuern) {
                /**
                 * Both renderRoundTop and renderSquareTop can be used if you want the square block top + the round
                 * stone animation
                 * The last parameter is for rendering the round stone sides, no need to render if you can't see them :)
                 */
                this.renderRoundTop(tess, teq.rotatetimer, teq.getWorldObj().rand, 0.8, true); // Renders a round Quern
                                                                                               // top stone
    ...
    private void renderRoundTop(Tessellator t, int pos, Random rand, double angle, Boolean renderSides) {
        ...
        if (pos > 0) center = 0.494 + (rand.nextDouble() * (0.003 - (-0.003))) + 0.003;
