    ...
    public void renderTileEntityLoomAt(TELoom te, double d, double d1, double d2, float f) {
        if (te.getWorldObj() != null) {
            ...
            if (stringCount < reqStringCount) {
                te.getModel()
                    .updateCloth(te.getCloth());
            }
            if (te.getIsWeaving() || te.getModel().stillWeaving) {
                if (TFC_Time.getTotalTicks() > te.getModel().tempTime) {
                    te.getModel().tempNum = te.getModel().tempNum
                        + (int) (TFC_Time.getTotalTicks() - te.getModel().tempTime);
                    ...
                    if (te.getModel().tempNum >= (te.getModel().lastClothIncrease + (te.getModel().mod / 2))) {
                        ...
                        te.getModel().lastClothIncrease = (te.getModel().lastClothIncrease + (te.getModel().mod / 2))
                            % te.getModel().mod;
            ...
            if (te.getStackInSlot(1) != null) // Render completed cloth
                ...
                te.getModel()
                    .render(
                        ...
                        reqStringCount,
                        te.getModel().tempNum,
                        te.getModel().clothIncrease,
                        te.getModel().mod,
                        te.getStringResource(),
                        te.getIsWeaving(),
                        te.getModel().stillWeaving,
                        te);
