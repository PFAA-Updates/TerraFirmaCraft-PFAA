    ...
    public void processCommand(ICommandSender sender, String[] params) {
        ...
        if (params.length == 0) {
            ...
            for (int x = 0; x < 16; x++) {
                for (int z = 0; z < 16; z++) {
                    for (int y = 0; y < 256; y++) {
                        ...
                        if (id != Blocks.air && id != TFCBlocks.ore
                            && id != TFCBlocks.ore2
                            && id != TFCBlocks.ore3
                            && id != Blocks.bedrock) {
            ...
            TFC_Core.sendInfoMessage(
                player,
                new ChatComponentText("Stripping Chunks Within a Radius of " + Integer.parseInt(params[0])));
                        ...
                        for (int z = 0; z < 16; z++) {
                            for (int y = 0; y < 256; y++) {
                                ...
                                if (id != Blocks.air && id != TFCBlocks.ore
                                    ...
                                    && id != TFCBlocks.ore3
                                    && id != Blocks.bedrock) {
                                    if (TFC_Core.isGround(id)) // Automatically replace ground blocks to help with
                                                               // performance
                                    {
                                        world.setBlock(
                                            x + (chunk.xPosition * 16),
