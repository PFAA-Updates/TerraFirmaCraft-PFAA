...
public class TEMetalSheet extends NetworkTileEntity {
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        if (sheetStack != null) sheetStack.writeToNBT(st);
