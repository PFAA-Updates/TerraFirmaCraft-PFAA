...
public class TEChest extends TileEntityChest implements IInventory {
    ...
    public ItemStack decrStackSize(int par1, int par2) {
        if (this.chestContents[par1] != null) {
            ...
            if (this.chestContents[par1].stackSize <= par2) {
                ...
                if (this.chestContents[par1].stackSize == 0) this.chestContents[par1] = null;
                this.markDirty();
                return var3;
            }
        } else return null;
    ...
    public boolean checkType(IBlockAccess access, int x, int y, int z) {
        ...
        if (te instanceof TEChest) {
            ...
            if (chest.type == this.type && this.cooldown == 0 && chest.cooldown == 0) return true;
        }
        return false;
    }
    ...
    public void checkForAdjacentChests() {
        if (!this.adjacentChestChecked) {
            ...
            if (isChest(xCoord - 1, yCoord, zCoord)) this.adjacentChestXNeg = (TEChest) this.worldObj
                .getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);

            if (isChest(xCoord + 1, yCoord, zCoord)) this.adjacentChestXPos = (TEChest) this.worldObj
                .getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);

            if (isChest(xCoord, yCoord, zCoord - 1)) this.adjacentChestZNeg = (TEChest) this.worldObj
                .getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);

            if (isChest(xCoord, yCoord, zCoord + 1)) this.adjacentChestZPos = (TEChest) this.worldObj
                .getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
    ...
    public void updateEntity() {
        ...
        if (this.numPlayersUsing > 0 && this.lidAngle == 0.0F
            ...
            if (this.adjacentChestZPos != null) var4 += 0.5D;
            if (this.adjacentChestXPos != null) var2 += 0.5D;
        ...
        if (this.numPlayersUsing == 0 && this.lidAngle > 0.0F || this.numPlayersUsing > 0 && this.lidAngle < 1.0F) {
            if (this.numPlayersUsing > 0) this.lidAngle += var1;
            else this.lidAngle -= var1;
            ...
            if (this.lidAngle < var3 && var8 >= var3
                ...
                if (this.adjacentChestZPos != null) var6 += 0.5D;
                if (this.adjacentChestXPos != null) var4 += 0.5D;
                this.worldObj.playSoundEffect(
                    var4,
                    this.yCoord + 0.5D,
                    var6,
