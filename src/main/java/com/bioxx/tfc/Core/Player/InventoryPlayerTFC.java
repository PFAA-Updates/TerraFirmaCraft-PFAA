...
public class InventoryPlayerTFC extends InventoryPlayer {
    ...
    public void damageArmor(float par1) {
        ...
        for (int i = 0; i < this.armorInventory.length; ++i) {
            if (this.armorInventory[i] != null && this.armorInventory[i].getItem() instanceof ItemArmor) {
                ...
                if (this.armorInventory[i].stackSize == 0) this.armorInventory[i] = null;
            }
        }
    }
    ...
    public void readFromNBT(NBTTagList par1NBTTagList) {
        ...
        NBTTagList extraList = player.getEntityData()
            .getTagList("ExtraInventory", 10);
    ...
    public void decrementAnimations() {
        for (int i = 0; i < this.extraEquipInventory.length; ++i) {
            if (this.extraEquipInventory[i] != null) {
                this.extraEquipInventory[i]
                    .updateAnimation(this.player.worldObj, this.player, i, this.currentItem == i);
            }
        }
