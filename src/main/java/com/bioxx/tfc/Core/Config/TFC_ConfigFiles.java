...
public class TFC_ConfigFiles {
    ...
    private static final String[] COLOR_CATEGORIES = { COLOR_NUTRIENT_A, COLOR_NUTRIENT_B, COLOR_NUTRIENT_C,
        CROP_FERTILIZER_COLOR, ANVIL_RULE_COLOR0, ANVIL_RULE_COLOR1, ANVIL_RULE_COLOR2 };
    ...
    private static final String[] ALLOWED_BASE_ROCKS = ObjectArrays.concat(
        Global.STONE_ALL,
        new String[] { "igneous intrusive", "igneous extrusive", "sedimentary", "metamorphic" },
        String.class);

    public static final Map<String, com.bioxx.tfc.Core.Config.SyncingOption> SYNCING_OPTION_MAP = new CaseInsensitiveHashMap<com.bioxx.tfc.Core.Config.SyncingOption>();
    ...
    public static void preInit(File configFolder) {
        ...
        generalConfig = new com.bioxx.tfc.Core.Config.TFC_Configuration(generalConfigFile);
    ...
    public static void reloadAll() {
        ...
        try {
            for (com.bioxx.tfc.Core.Config.SyncingOption option : SYNCING_OPTION_MAP.values()) {
    ...
    public static void firstLoadCrafting() {
        ...
        try {
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "appleConversion",
                getAsShapeless(new ItemStack(Items.apple, 1), new ItemStack(TFCItems.redApple, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "arrowConversion",
                getAsShapeless(new ItemStack(Items.arrow, 1), new ItemStack(TFCItems.arrow, 1)),
                getAsShapeless(new ItemStack(TFCItems.arrow, 1), new ItemStack(Items.arrow, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "bowConversion",
                getAsShapeless(new ItemStack(Items.bow, 1), new ItemStack(TFCItems.bow, 1, 0)),
                getAsShapeless(new ItemStack(TFCItems.bow, 1, 0), new ItemStack(Items.bow, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "coalConversion",
                getAsShapeless(new ItemStack(Items.coal, 1), new ItemStack(TFCItems.coal, 1)),
                getAsShapeless(new ItemStack(TFCItems.coal, 1), new ItemStack(Items.coal, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "diamondConversion",
                getAsShapeless(new ItemStack(Items.diamond, 1), new ItemStack(TFCItems.gemDiamond, 1, 2)),
                ...
                getAsShapeless(
                    new ItemStack(TFCItems.gemDiamond, 1, 3),
                    new ItemStack(Items.diamond),
                    new ItemStack(Items.diamond)),
                getAsShapeless(
                    new ItemStack(TFCItems.gemDiamond, 1, 4),
                    new ItemStack(Items.diamond),
                    new ItemStack(Items.diamond),
                    new ItemStack(Items.diamond)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "emeraldConversion",
                getAsShapeless(new ItemStack(Items.emerald, 1), new ItemStack(TFCItems.gemEmerald, 1, 2)),
                ...
                getAsShapeless(
                    new ItemStack(TFCItems.gemEmerald, 1, 3),
                    new ItemStack(Items.emerald),
                    new ItemStack(Items.emerald)),
                getAsShapeless(
                    new ItemStack(TFCItems.gemEmerald, 1, 4),
                    new ItemStack(Items.emerald),
                    new ItemStack(Items.emerald),
                    new ItemStack(Items.emerald)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "fishConversion",
                getAsShapeless(new ItemStack(Items.fish, 1), new ItemStack(TFCItems.fishRaw, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "fishingRodConversion",
                getAsShapeless(new ItemStack(Items.fishing_rod, 1), new ItemStack(TFCItems.fishingRod, 1, 0)),
                getAsShapeless(new ItemStack(TFCItems.fishingRod, 1, 0), new ItemStack(Items.fishing_rod, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "flintSteelConversion",
                getAsShapeless(new ItemStack(Items.flint_and_steel, 1, 0), new ItemStack(TFCItems.flintSteel, 1, 0)),
                getAsShapeless(new ItemStack(TFCItems.flintSteel, 1, 0), new ItemStack(Items.flint_and_steel, 1, 0)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "leatherArmorConversion",
                getAsShapeless(new ItemStack(Items.leather_helmet, 1, 0), new ItemStack(TFCItems.leatherHelmet, 1, 0)),
                ...
                getAsShapeless(
                    ...
                    new ItemStack(TFCItems.leatherChestplate, 1, 0)),
                getAsShapeless(
                    new ItemStack(TFCItems.leatherChestplate, 1, 0),
                    new ItemStack(Items.leather_chestplate, 1, 0)),
                getAsShapeless(
                    new ItemStack(Items.leather_leggings, 1, 0),
                    new ItemStack(TFCItems.leatherLeggings, 1, 0)),
                getAsShapeless(
                    new ItemStack(TFCItems.leatherLeggings, 1, 0),
                    new ItemStack(Items.leather_leggings, 1, 0)),
            ...
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "leatherConversion",
                getAsShapeless(new ItemStack(Items.leather, 1), new ItemStack(TFCItems.leather, 1)),
                getAsShapeless(new ItemStack(TFCItems.leather, 1), new ItemStack(Items.leather, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "stoneAxeConversion",
                getAsShapeless(new ItemStack(Items.stone_axe, 1, 0), TFCItems.igInAxe),
            ...
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "stoneHoeConversion",
                getAsShapeless(new ItemStack(Items.stone_hoe, 1, 0), TFCItems.igInHoe),
            ...
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "stoneShovelConversion",
                getAsShapeless(new ItemStack(Items.stone_shovel, 1, 0), TFCItems.igInShovel),
            ...
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "woodButtonConversion",
                getAsShapeless(new ItemStack(Blocks.wooden_button, 1), new ItemStack(TFCBlocks.buttonWood, 1)),
                getAsShapeless(new ItemStack(TFCBlocks.buttonWood, 1), new ItemStack(Blocks.wooden_button, 1)));
            new com.bioxx.tfc.Core.Config.ConversionOption(
                "workbenchConversion",
                getAsShapeless(new ItemStack(Blocks.crafting_table, 1), new ItemStack(TFCBlocks.workbench, 1)),
                getAsShapeless(new ItemStack(TFCBlocks.workbench, 1), new ItemStack(Blocks.crafting_table, 1)));

            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("anvilRecipe", new ItemStack(Blocks.anvil));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("arrowsRecipe", new ItemStack(Items.arrow, 4));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("bedRecipe", new ItemStack(Items.bed));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("bonemealRecipe", new ItemStack(Items.dye, 3, 15));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("bowlRecipe", new ItemStack(Items.bowl, 4));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("brewingRecipe", new ItemStack(Items.brewing_stand));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("bucketRecipe", new ItemStack(Items.bucket));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("cauldronRecipe", new ItemStack(Items.cauldron));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("chestRecipe", new ItemStack(Blocks.chest));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("clockRecipe", new ItemStack(Items.clock));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("compassRecipe", new ItemStack(Items.compass));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "dandelionYellowRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("dispenserRecipe", new ItemStack(Blocks.dispenser));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("dropperRecipe", new ItemStack(Blocks.dropper));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "enchantTableRecipe",
                new ItemStack(Blocks.enchanting_table));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("fenceGateRecipe", new ItemStack(Blocks.fence_gate));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("fenceRecipe", new ItemStack(Blocks.fence, 2));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("furnaceRecipe", new ItemStack(Blocks.furnace));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("goldAppleRecipe", new ItemStack(Items.golden_apple));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "goldArmorRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("goldBlockRecipe", new ItemStack(Blocks.gold_block));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("goldNuggetRecipe", new ItemStack(Items.gold_nugget, 9));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "goldPlateRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("hopperRecipe", new ItemStack(Blocks.hopper));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "ironArmorRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("ironBarsRecipe", new ItemStack(Blocks.iron_bars, 16));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("ironBlockRecipe", new ItemStack(Blocks.iron_block));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("ironDoorRecipe", new ItemStack(Items.iron_door));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "ironPlateRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("jukeboxRecipe", new ItemStack(Blocks.jukebox));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "leatherArmorRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("leverRecipe", new ItemStack(Blocks.lever));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "minecartChestRecipe",
                new ItemStack(Items.chest_minecart));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("minecartRecipe", new ItemStack(Items.minecart));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("pistonRecipe", new ItemStack(Blocks.piston));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "plankBlockRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "poweredRailsRecipe",
                new ItemStack(Blocks.golden_rail, 6));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("railsRecipe", new ItemStack(Blocks.rail, 16));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("repeaterRecipe", new ItemStack(Items.repeater));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "roseRedRecipe",
                new ItemStack(Items.dye, 1, 1),
                new ItemStack(Items.dye, 2, 1));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("shearsRecipe", new ItemStack(Items.shears));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("signRecipe", new ItemStack(Items.sign, 3));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("stickRecipe", new ItemStack(Items.stick, 4));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "stoneSlabsRecipe",
                new ItemStack(Blocks.stone_slab, 6),
                new ItemStack(Blocks.stone_slab, 6, 3));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "stoneStairsRecipe",
                new ItemStack(Blocks.stone_stairs, 4));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "stoneToolsRecipe",
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("torchRecipe", new ItemStack(Blocks.torch, 4));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("trapDoorRecipe", new ItemStack(Blocks.trapdoor, 2));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("tripwireRecipe", new ItemStack(Blocks.tripwire_hook, 2));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("woodDoorRecipe", new ItemStack(Items.wooden_door));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "woodSlabsRecipe",
                new ItemStack(Blocks.wooden_slab, 6, 0),
                new ItemStack(Blocks.wooden_slab, 6, 1),
                new ItemStack(Blocks.wooden_slab, 6, 2),
                new ItemStack(Blocks.wooden_slab, 6, 3),
                new ItemStack(Blocks.wooden_slab, 6, 4),
                new ItemStack(Blocks.wooden_slab, 6, 5));
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption(
                "woodStairsRecipe",
                new ItemStack(Blocks.birch_stairs, 4),
                new ItemStack(Blocks.jungle_stairs, 4),
                new ItemStack(Blocks.oak_stairs, 4),
                new ItemStack(Blocks.spruce_stairs, 4),
                new ItemStack(Blocks.acacia_stairs, 4),
            ...
            new com.bioxx.tfc.Core.Config.VanillaRecipeOption("woolRecipe", new ItemStack(Blocks.wool));

            /**
             * Custom SyncingOption for enableBowlsAlwaysBreak
             * getRecipes() is unused, but returns an ImmutableList of the bowl crafting recipe for conviniance &
             * consistency.
             */
            new com.bioxx.tfc.Core.Config.SyncingOption(
                "enableBowlsAlwaysBreak",
                TFCCrafting.class,
                craftingConfig,
                CRAFTING_OPTIONS) {

                private IRecipe recipesTFC = CraftingManagerTFC.getInstance()
                    .addRecipe(
                        new ItemStack(TFCItems.potteryBowl, 2),
                        new Object[] { "#####", "#####", "#####", " ### ", "#   #", '#',
                ...
                public void apply(boolean enabled) throws IllegalAccessException {
                    if (currentValue != enabled) // if we need to change states
                    {
                        ...
                        if (enableDebugMode) TerraFirmaCraft.LOG.info(
                            "Crafting option {} changed from {} to {}. Stacksize {}",
                            name,
                            currentValue,
                            enabled,
                            recipesTFC.getRecipeOutput().stackSize);
    ...
    private static ShapelessRecipes getAsShapeless(ItemStack out, Object... in) {
        ...
        for (int i = 0; i < in.length; i++) {
            if (in[i] instanceof ItemStack) {
                ingredients.add((ItemStack) in[i]);
            } else if (in[i] instanceof Item) {
                ingredients.add(new ItemStack((Item) in[i]));
            } else if (in[i] instanceof Block) {
                ingredients.add(new ItemStack((Block) in[i]));
            } else {
                throw new IllegalArgumentException(
                    "Type of " + in[i] + " (arg #" + i + ") not ItemStack, Item, or Block.");
            }
        }

        return new ShapelessRecipes(out, ingredients);
    }
    ...
    public static void reloadGeneral() {
        ...
        if (craftingConfig.hasCategory("nei hiding")) generalConfig.get(GENERAL, "enableNEIHiding", enableNEIHiding)
            .set(craftingConfig.getBoolean("enableNEIHiding", "nei hiding", enableNEIHiding, ""));

        enableNEIHiding = generalConfig.getBoolean(
            "enableNEIHiding",
            GENERAL,
            enableNEIHiding,
        ...
        enablePowderKegs = generalConfig.getBoolean(
            ...
            "config.gui.TFCConfig.general.enablePowderKegs");
        enableBetterGrass = generalConfig.getBoolean(
            "enableBetterGrass",
            GENERAL,
            enableBetterGrass,
            ...
            "config.gui.TFCConfig.general.enableBetterGrass");
        enableSaplingDrops = generalConfig.getBoolean(
            "enableSaplingDrops",
            GENERAL,
            enableSaplingDrops,
            "Set this to false to disable saplings dropping from harvested leaf blocks.",
            "config.gui.TFCConfig.general.enableSaplingDrops");
        enableSeedDrops = generalConfig.getBoolean(
            "enableSeedDrops",
            GENERAL,
            enableSeedDrops,
            "Set this to false to disable seeds being placed on the ground when a crop on farmland dies from natural causes such as freezing temperatures, old age, or not enough sunlight.",
            "config.gui.TFCConfig.general.enableSeedDrops");
        enableDebugMode = generalConfig.getBoolean(
            "enableDebugMode",
            GENERAL,
            enableDebugMode,
            "Set this to true if you want to turn on debug mode which is useful for bug hunting.",
            "config.gui.TFCConfig.general.enableDebugMode");
        enableFiniteWater = generalConfig.getBoolean(
            "enableFiniteWater",
            GENERAL,
            enableFiniteWater,
            "Set this to true to enable finite water. Two adjacent source water blocks will not create a third.",
            "config.gui.TFCConfig.general.enableFiniteWater");
        onionsAreGross = generalConfig.getBoolean(
            "onionsAreGross",
            GENERAL,
            onionsAreGross,
            "Set this to true if you don't like onions.",
            "config.gui.TFCConfig.general.onionsAreGross");
        quiverHUDPosition = generalConfig.getString(
            "quiverHUDPosition",
            GENERAL,
            quiverHUDPosition,
            "Valid position strings are: bottomleft, left, topleft, bottomright, right, topright",
            new String[] { "bottomleft", "left", "topleft", "bottomright", "right", "topright" },
            "config.gui.TFCConfig.general.quiverHUDPosition");
        enableSolidDetailed = generalConfig.getBoolean(
            "enableSolidDetailed",
            GENERAL,
            enableSolidDetailed,
            "Should sides of detailed blocks be considered solid?",
            "config.gui.TFCConfig.general.enableSolidDetailed");
        maxRemovedSolidDetailed = generalConfig.getInt(
            "maxRemovedSolidDetailed",
            GENERAL,
            maxRemovedSolidDetailed,
            0,
            64,
            "Maximum count of removed sub-blocks on one side for the detailed block side to still be solid.",
            "config.gui.TFCConfig.general.maxRemovedSolidDetailed");
        enableToolModeIndicator = generalConfig.getBoolean(
        ...
        yearLength = generalConfig.getInt(
            "yearLength",
            TIME,
            yearLength,
            96,
            ...
            "config.gui.TFCConfig.time.yearLength");
        if (yearLength % 12 != 0) {
        ...
        pitKilnBurnTime = generalConfig.getFloat(
            ...
            "config.gui.TFCConfig.time.pitKilnBurnTime");
        bloomeryBurnTime = generalConfig.getFloat(
            "bloomeryBurnTime",
            TIME,
            bloomeryBurnTime,
            1.0f,
            ...
            "config.gui.TFCConfig.time.bloomeryBurnTime");
        charcoalPitBurnTime = generalConfig.getFloat(
            "charcoalPitBurnTime",
            TIME,
            charcoalPitBurnTime,
            1.0f,
            ...
            "config.gui.TFCConfig.time.charcoalPitBurnTime");
        torchBurnTime = generalConfig.getInt(
            "torchBurnTime",
            TIME,
            torchBurnTime,
            0,
            ...
            "config.gui.TFCConfig.time.torchBurnTime");
        saplingTimerMultiplier = generalConfig.getFloat(
            "saplingTimerMultiplier",
            TIME,
            saplingTimerMultiplier,
            0.01f,
            100.0f,
            ...
            "config.gui.TFCConfig.time.saplingTimerMultiplier");
        tempIncreaseMultiplier = generalConfig.getFloat(
            ...
            "config.gui.TFCConfig.time.tempIncreaseMultiplier");
        tempDecreaseMultiplier = generalConfig.getFloat(
            ...
            "config.gui.TFCConfig.time.tempDecreaseMultiplier");
        oilLampFuelMult = generalConfig.getInt(
            "oilLampFuelMult",
            TIME,
            oilLampFuelMult,
            1,
            ...
            "config.gui.TFCConfig.time.oilLampFuelMult");
        animalTimeMultiplier = generalConfig.getFloat(
            "animalTimeMultiplier",
            TIME,
            animalTimeMultiplier,
            0.01f,
            100.0f,
            "This is a global multiplier for the gestation period of animals, as well as how long it takes for them to reach adulthood. Decrease for faster times.",
            "config.gui.TFCConfig.time.animalTimeMultiplier");

        generalConfig.setCategoryLanguageKey(FOOD_DECAY, "config.gui.TFCConfig.fooddecay");

        foodDecayRate = generalConfig.getFloat(
            "foodDecayRate",
            FOOD_DECAY,
            foodDecayRate,
            1.0f,
            ...
            "config.gui.TFCConfig.fooddecay.foodDecayRate");
        useDecayProtection = generalConfig.getBoolean(
            "useDecayProtection",
            FOOD_DECAY,
            useDecayProtection,
            ...
            "config.gui.TFCConfig.fooddecay.useDecayProtection");
        decayProtectionDays = generalConfig.getInt(
            "decayProtectionDays",
            FOOD_DECAY,
            decayProtectionDays,
            1,
            ...
            "config.gui.TFCConfig.fooddecay.decayProtectionDays");
        decayMultiplier = generalConfig.getFloat(
            "foodDecayMultiplier",
            FOOD_DECAY,
            decayMultiplier,
            0.0f,
            ...
            "config.gui.TFCConfig.fooddecay.foodDecayMultiplier");

        generalConfig.setCategoryLanguageKey(CAVEIN_OPTIONS, "config.gui.TFCConfig.caveins");

        minimumRockLoad = generalConfig.getInt(
            "minimumRockLoad",
            CAVEIN_OPTIONS,
            minimumRockLoad,
            0,
            ...
            "config.gui.TFCConfig.caveins.minimumRockLoad");
        initialCollapseRatio = generalConfig.getInt(
            "initialCollapseRatio",
            CAVEIN_OPTIONS,
            initialCollapseRatio,
            1,
            1000,
            "This number is a 1 in X chance that when you mine a block, a collapse will occur.",
            "config.gui.TFCConfig.caveins.initialCollapseRatio");
        propogateCollapseChance = generalConfig.getInt(
            "propogateCollapseChance",
            CAVEIN_OPTIONS,
            propogateCollapseChance,
            1,
            100,
            "This number is the likelihood for each block to propagate the collapse farther.",
            "config.gui.TFCConfig.caveins.propogateCollapseChance");
        enableCaveIns = generalConfig.getBoolean(
            "enableCaveIns",
            CAVEIN_OPTIONS,
            enableCaveIns,
            "Set this to false to disable cave-ins.",
            "config.gui.TFCConfig.caveins.enableCaveIns");
        enableCaveInsDestroyOre = generalConfig.getBoolean(
            "enableCaveInsDestroyOre",
            CAVEIN_OPTIONS,
            enableCaveInsDestroyOre,
            "Set this to false to make cave-ins drop the ore item instead of destroy it.",
            "config.gui.TFCConfig.caveins.enableCaveInsDestroyOre");

        generalConfig.setCategoryLanguageKey(WORLD_GEN, "config.gui.TFCConfig.worldgen");

        ravineRarity = generalConfig.getInt(
            "ravineRarity",
            WORLD_GEN,
            ravineRarity,
            0,
            1000,
            "Controls the chance of a ravine generating, smaller value is higher chance, more ravines. Set to 0 to disable ravines.",
            "config.gui.TFCConfig.worldgen.ravineRarity");
        lavaFissureRarity = generalConfig.getInt(
            "lavaFissureRarity",
            WORLD_GEN,
            lavaFissureRarity,
            0,
            1000,
            "Controls the chance of a lava fissure generating, smaller value is higher chance, more fissures. Set to 0 to disable lava fissures.",
            "config.gui.TFCConfig.worldgen.lavaFissureRarity");
        waterFissureRarity = generalConfig.getInt(
            "waterFissureRarity",
            WORLD_GEN,
            waterFissureRarity,
            0,
        ...
        enableCropsDie = generalConfig.getBoolean(
            "enableCropsDie",
            CROPS,
            enableCropsDie,
            "Set to true to enable crop death from old age.",
            "config.gui.TFCConfig.crops.enableCropsDie");
        cropGrowthMultiplier = generalConfig.getFloat(
            "cropGrowthModifier",
            CROPS,
            ...
            "config.gui.TFCConfig.crops.cropGrowthModifier");

        generalConfig.setCategoryLanguageKey(PROTECTION, "config.gui.TFCConfig.protection");

        maxProtectionMonths = generalConfig.getInt(
            "maxProtectionMonths",
            PROTECTION,
            maxProtectionMonths,
            0,
            ...
            "config.gui.TFCConfig.protection.maxProtectionMonths");
        protectionGain = generalConfig.getInt(
            "protectionGain",
            PROTECTION,
            protectionGain,
            0,
            ...
            "config.gui.TFCConfig.protection.protectionGain");
        protectionBuffer = generalConfig.getInt(
            "protectionBuffer",
            PROTECTION,
            protectionBuffer,
            0,
            ...
            "config.gui.TFCConfig.protection.protectionBuffer");

        generalConfig.setCategoryLanguageKey(PLAYER, "config.gui.TFCConfig.player");

        healthGainRate = generalConfig.getInt(
            "healthGainRate",
            PLAYER,
            healthGainRate,
            0,
            ...
            "config.gui.TFCConfig.player.healthGainRate");
        healthGainCap = generalConfig.getInt(
            "healthGainCap",
            PLAYER,
            healthGainCap,
            1000,
        ...
        smallOreUnits = generalConfig.getInt(
            ...
            "config.gui.TFCConfig.materials.smallOreUnits");
        poorOreUnits = generalConfig.getInt(
            "poorOreUnits",
            MATERIALS,
            poorOreUnits,
            1,
            ...
            "config.gui.TFCConfig.materials.poorOreUnits");
        normalOreUnits = generalConfig.getInt(
            "normalOreUnits",
            MATERIALS,
            normalOreUnits,
            1,
            ...
            "config.gui.TFCConfig.materials.normalOreUnits");
        richOreUnits = generalConfig.getInt(
            "richOreUnits",
            MATERIALS,
            richOreUnits,
            1,
            ...
            "config.gui.TFCConfig.materials.richOreUnits");

        generalConfig.setCategoryLanguageKey(SERVER, "config.gui.TFCConfig.server");

        simSpeedNoPlayers = generalConfig.getInt(
            "simSpeedNoPlayers",
            SERVER,
            simSpeedNoPlayers,
            0,
            Integer.MAX_VALUE,
            "For every X number of ticks provided here, when there are no players online the server will only progress by 1 tick. Time advances 100 times slower than normal. Setting this to 0 will turn this feature off.",
            "config.gui.TFCConfig.server.simSpeedNoPlayers");

        generalConfig.setCategoryLanguageKey(OVERWORKED, "config.gui.TFCConfig.overworked");

        enableOverworkingChunks = generalConfig.getBoolean(
            "enableOverworkingChunks",
            OVERWORKED,
            enableOverworkingChunks,
            "Set this to false to disable the overworking of chunks when using a gold pan or sluice.",
            "config.gui.TFCConfig.overworked.enableOverworkingChunks");
        goldPanLimit = generalConfig.getInt(
            "goldPanLimit",
            OVERWORKED,
            goldPanLimit,
            1,
            ...
            "config.gui.TFCConfig.overworked.goldPanLimit");
        sluiceLimit = generalConfig.getInt(
            "sluiceLimit",
            OVERWORKED,
            sluiceLimit,
            1,
     ...
     * To deal with the fact that bytes are signed in java, and we like to use 0 - 255 in the config, values are being
     * "& 0xFF".
     */
    ...
    public static void reloadOres() {
        ...
        oreList.put(
            ...
            getOreData(
                ...
                1,
                120,
                new String[] { "igneous extrusive", "igneous intrusive" },
                5,
                128,
                80,
                60));
        ...
        oreList.put(
            ...
            getOreData(
                ...
                6,
                100,
                new String[] { "igneous extrusive", "metamorphic", "granite", "limestone" },
                5,
                128,
                80,
                60));
        oreList.put(
            ...
            getOreData(
                ...
                7,
                100,
                new String[] { "igneous extrusive", "sedimentary" },
                5,
                128,
                80,
                60));
        ...
        oreList.put(
            ...
            getOreData(
                ...
                80,
                60));
        // WorldGenOre.OreList.put("Satinspar", getOreData("Satinspar", "veins", "small", Reference.ModID + ":Ore2", 2,
        // 150, new String[]{"sedimentary"}, 5, 128, 40, 80));
        // WorldGenOre.OreList.put("Selenite", getOreData("Selenite", "veins", "medium", Reference.ModID + ":Ore2", 3,
        // 125, new String[]{"igneous extrusive"}, 5, 128, 60, 60));
        oreList.put(
            "Graphite",
            getOreData(
                "Graphite",
                ...
                4,
                100,
                new String[] { "marble", "gneiss", "quartzite", "schist" },
                5,
                128,
                80,
                60));
        oreList.put(
            ...
            getOreData(
                ...
                30,
                80));
        // WorldGenOre.OreList.put("Petrified Wood", getOreData("Petrified Wood", "veins", "medium", Reference.ModID +
        // ":Ore2", 6, 100, new String[]{"igneous extrusive", "metamorphic", "granite", "limestone"}, 5, 128, 60, 60));
        // WorldGenOre.OreList.put("Sulfur", getOreData("Sulfur", "veins", "medium", Reference.ModID + ":Ore2", 7, 100,
        // new String[]{"igneous extrusive", "sedimentary"}, 5, 128, 60, 60));
        oreList.put(
            "Jet",
            getOreData(
                "Jet",
                ...
                80,
                60));
        // WorldGenOre.OreList.put("Microcline", getOreData("Microcline", "veins", "large", Reference.ModID + ":Ore2",
        // 9, 100, new String[]{"limestone", "marble"}, 5, 128, 60, 60));
        oreList.put(
            "Pitchblende",
            getOreData(
                "Pitchblende",
        ...
        oreList.put(
            ...
            getOreData(
                ...
                11,
                150,
                new String[] { "igneous extrusive", "shale", "quartzite" },
                5,
                128,
                30,
                80));
        ...
        oreList.put(
            ...
            getOreData(
                ...
                80,
                60));
        // WorldGenOre.OreList.put("Serpentine", getOreData("Serpentine", "veins", "large", Reference.ModID + ":Ore2",
        // 14, 100, new String[]{"sedimentary"}, 5, 128, 90, 40));
        oreList.put(
            "Sylvite",
            getOreData(
                "Sylvite",
        ...
        oreList.put(
            ...
            getOreData(
                ...
                80,
                60));
        // WorldGenOre.OreList.put("Olivine", getOreData("Olivine", "veins", "small", Reference.ModID + ":Ore3", 1, 150,
        // new String[]{"sedimentary"}, 5, 128, 40, 80));
        ...
        for (String s : oresConfig.getCategoryNames()) {
            ...
            if (!oreList.containsKey(s)) oreList.put(
                s,
                getOreData(
                    s,
                    "default",
                    ...
                    0,
                    100,
                    new String[] { "granite", "basalt", "sedimentary" },
                    5,
                    128,
                    50,
                    50));
    ...
    private static OreSpawnData getOreData(String category, String type, String size, String blockName, int meta,
        int rarity, String[] rocks, int min, int max, int v, int h) {
        return new OreSpawnData(
            oresConfig.get(category, "type", type)
                .setValidValues(ALLOWED_TYPES)
                .getString(),
            oresConfig.get(category, "size", size)
                .setValidValues(ALLOWED_SIZES)
                .getString(),
            oresConfig.get(category, "oreName", blockName)
                .getString(),
            oresConfig.get(category, "oreMeta", meta)
                .getInt(),
            oresConfig.get(category, "rarity", rarity)
                .getInt(),
            oresConfig.get(category, "baseRocks", rocks)
                .setValidValues(ALLOWED_BASE_ROCKS)
                .getStringList(),
            oresConfig.get(category, "Minimum Height", min)
                .getInt(),
            oresConfig.get(category, "Maximum Height", max)
                .getInt(),
            oresConfig.get(category, "Vertical Density", v)
                .getInt(),
            oresConfig.get(category, "Horizontal Density", h)
                .getInt());
    }
}
