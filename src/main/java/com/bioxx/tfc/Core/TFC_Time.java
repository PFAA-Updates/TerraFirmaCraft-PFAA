...
public class TFC_Time {
    ...
    public static final String[] SEASONS = { TFC_Core.translate("gui.Calendar.EarlySpring"),
    ...
    public static final String[] MONTHS = { TFC_Core.translate("gui.Calendar.March"),
    ...
    public static final String[] DAYS = { TFC_Core.translate("gui.Calendar.Sunday"),
    ...
    public static void updateTime(World world) {
        ...
        if (time < startTime) {
            ...
            world.getWorldInfo()
                .incrementTotalWorldTime(startTime);
        }
