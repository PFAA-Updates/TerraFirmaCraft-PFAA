...
public enum EnumFuelMaterial {
    ...
    CHESTNUT("CHESTNUT", 651, 1500,
        new int[] { /* Sweet */6, /* Sour */-5, /* Salty */0, /* Bitter */-6, /* Savory */-5 }),
    DOUGLASFIR("DOUGLASFIR", 707, 1500,
        new int[] { /* Sweet */-14, /* Sour */14, /* Salty */0, /* Bitter */18, /* Savory */-9 }),
    HICKORY("HICKORY", 762, 2000,
        new int[] { /* Sweet */-5, /* Sour */-6, /* Salty */0, /* Bitter */-8, /* Savory */13 }),
    ...
    REDWOOD("REDWOOD", 612, 1750,
        new int[] { /* Sweet */-13, /* Sour */9, /* Salty */0, /* Bitter */12, /* Savory */6 }),
    SPRUCE("SPRUCE", 608, 1500,
        new int[] { /* Sweet */-17, /* Sour */16, /* Salty */0, /* Bitter */-9, /* Savory */-13 }),
    SYCAMORE("SYCAMORE", 653, 1750,
        new int[] { /* Sweet */8, /* Sour */15, /* Salty */0, /* Bitter */17, /* Savory */-6 }),
    WHITECEDAR("WHITECEDAR", 625, 1500, new int[] { /* Sweet */-5, /* Sour */9, /* Salty */0, /* Bitter */16, /*
                                                                                                               * Savory
                                                                                                               */-3 }),
    WHITEELM("WHITEELM", 647, 1750,
        new int[] { /* Sweet */0, /* Sour */0, /* Salty */0, /* Bitter */0, /* Savory */0 }),
    ...
    CHARCOAL("CHARCOAL", 1350, 1800,
        new int[] { /* Sweet */-10, /* Sour */8, /* Salty */0, /* Bitter */4, /* Savory */15 }),
    ...
    public static int[] getFuelProfile(int ordinal) {
        if (ordinal < 0 || ordinal > values().length) return new int[] { 0, 0, 0, 0, 0 };
