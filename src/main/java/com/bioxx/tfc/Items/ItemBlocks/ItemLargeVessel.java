...
public class ItemLargeVessel extends ItemTerraBlock implements IEquipable {
        ...
        if (nbt != null) {
            ...
            if (nbt.hasKey("fluidNBT")) {
                ...
                if (fluid != null) {
                    addFluid = true;
                    arraylist.add(
                        EnumChatFormatting.BLUE + fluid.getFluid()
                ...
                if (nbttaglist != null) {
                    ...
                    for (int i = 0; i < numItems; i++) {
                        ...
                        if (nbttagcompound1 != null) {
                            ...
                            if (onlyItem != null) {
                                arraylist.add(
                                    EnumChatFormatting.GOLD + Integer.toString(onlyItem.stackSize)
                                        + "x "
                                        + onlyItem.getDisplayName());
                            }
                        }
                    }
                    if (showMoreText) {
    ...
    public void addInformation(ItemStack is, EntityPlayer player, List arraylist, boolean flag) {
        ...
        } else arraylist.add(TFC_Core.translate("gui.ShowHelp"));
    }
    ...
    public boolean placeBlockAt(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (metadata > 0) {
            ...
            if (base != TFCBlocks.pottery && world.isAirBlock(x, y, z)) {
                ...
                if (!world.isSideSolid(x, y - 1, z, ForgeDirection.UP)) return false;
