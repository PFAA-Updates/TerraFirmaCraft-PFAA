    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int x, int y, int z, int side,
        ...
        if (!world.isRemote) {
            if (itemstack.getItem() == TFCItems.hide && itemstack.getItemDamage() >= 2) {
                ...
                if (world.getBlock(x, y, z) == TFCBlocks.thatch && side == 1
                    && world.getBlock(x2, y, z2) == TFCBlocks.thatch
                    && world.isAirBlock(x, y + 1, z)
                    && world.isAirBlock(x2, y + 1, z2)) {
                ...
                if (world.getBlock(x, y, z) instanceof BlockLogHoriz && world.isAirBlock(x, y + 1, z)
                    && world.setBlock(x, y + 1, z, TFCBlocks.leatherRack)) {
