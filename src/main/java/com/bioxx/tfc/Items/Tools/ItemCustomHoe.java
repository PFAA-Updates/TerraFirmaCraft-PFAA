...
public class ItemCustomHoe extends ItemHoe implements ISize {
    ...
    public boolean onItemUseFirst(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (world.isRemote || world.getBlock(x, y, z) == TFCBlocks.toolRack) return false;
        else {
            ...
            if (side != 1 || !var9.isAir(world, x, y + 1, z) || !TFC_Core.isGrass(var8) && !isDirt) return false;
            else {
                Block var10 = var8 == TFCBlocks.dirt || var8 == TFCBlocks.grass || var8 == TFCBlocks.dryGrass
                    ? TFCBlocks.dirt
                    : var8 == TFCBlocks.dirt2 || var8 == TFCBlocks.grass2 || var8 == TFCBlocks.dryGrass2
                        ? TFCBlocks.dirt2
                        : null;
                if (var10 != null) {
                    ...
                    if (var10 == TFCBlocks.dirt) {
                        world.playSoundEffect(
                            ...
                            y + 0.5F,
                            z + 0.5F,
                            var10.stepSound.getStepResourcePath(),
                            (var10.stepSound.getVolume() + 1.0F) / 2.0F,
                            var10.stepSound.getPitch() * 0.8F);
