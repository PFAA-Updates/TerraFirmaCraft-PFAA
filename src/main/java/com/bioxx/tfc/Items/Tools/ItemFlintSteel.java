...
public class ItemFlintSteel extends ItemFlintAndSteel implements ISize {
    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int x, int y, int z, int side,
        ...
        if (!world.isRemote) {
            ...
            if (block == TFCBlocks.charcoal && world.getBlockMetadata(x, y, z) > 6 || block == Blocks.coal_block) {
            ...
            else if (side == 1 && TFC_Core.isTopFaceSolid(world, x, y, z)
                ...
                && block.getMaterial() != Material.cloth) {
                    ...
                    if (list != null && !list.isEmpty()) {
                        ...
                        if (numsticks >= 3) {
                            ...
                            if (world.isRemote) world.markBlockForUpdate(x, y + 1, z);
                            return true;
                        }
                    }
                }
