...
public class ContainerForge extends ContainerTFC {
    ...
    public ItemStack transferStackInSlotTFC(EntityPlayer player, int slotNum) {
        ...
        Slot[] slotfuel = { (Slot) inventorySlots.get(7), (Slot) inventorySlots.get(6), (Slot) inventorySlots.get(8),
            (Slot) inventorySlots.get(5), (Slot) inventorySlots.get(9) };
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (slotNum < 14) {
                if (!this.mergeItemStack(slotStack, 14, this.inventorySlots.size(), true)) return null;
            }
            // From Inventory to forge
                ...
                if (slotStack.getItem() == TFCItems.coal) {
                    ...
                    if (j > 0 && !this.mergeItemStack(slotStack, 10, 14, false)) return null;
                }
    ...
    public void detectAndSendChanges() {
        ...
        for (int var1 = 0; var1 < this.crafters.size(); ++var1) {
            ...
            if (this.firetemp != this.forge.fireTemp) var2.sendProgressBarUpdate(this, 0, (int) this.forge.fireTemp);
        }
    ...
    public void updateProgressBar(int par1, int par2) {
        if (par1 == 0) this.forge.fireTemp = par2;
    }
}
