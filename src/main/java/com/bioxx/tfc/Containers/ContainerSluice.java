...
public class ContainerSluice extends ContainerTFC {
    ...
    public ContainerSluice(InventoryPlayer inventoryplayer, TESluice tileentitysluice, World world, int x, int y,
        int z) {
    ...
    public void detectAndSendChanges() {
        ...
        for (int var1 = 0; var1 < this.crafters.size(); ++var1) {
            ...
            if (this.soilamt != this.sluice.soilAmount) var2.sendProgressBarUpdate(this, 0, this.sluice.soilAmount);
    ...
    public void updateProgressBar(int par1, int par2) {
        if (par1 == 0) this.sluice.soilAmount = par2;
        if (par1 == 1) this.sluice.processTimeRemaining = par2;
    }
}
