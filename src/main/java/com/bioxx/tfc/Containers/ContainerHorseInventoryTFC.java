...
public class ContainerHorseInventoryTFC extends ContainerTFC {
    ...
    public boolean canInteractWith(EntityPlayer player) {
        return this.horseInv.isUseableByPlayer(player) && this.horse.isEntityAlive()
            && this.horse.getDistanceToEntity(player) < 8.0F;
    }
    ...
    public ItemStack transferStackInSlotTFC(EntityPlayer player, int slotNum) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (this.getSlot(1)
                .isItemValid(slotStack)
                && !this.getSlot(1)
                    .getHasStack()) {
