        ...
        if (accessor.getTileEntity() instanceof TECrucible) {
            ...
            if (currentAlloy != null) {
                ...
                if (currentAlloy.outputType != null) {
                    metalTypeUnits = EnumChatFormatting.UNDERLINE
                        + TFC_Core.translate("gui.metal." + currentAlloy.outputType.name.replace(" ", ""));
                }
                ...
                for (int c = 0; c < currentAlloy.alloyIngred.size(); c++) {
                    ...
                    if (currentAlloy.alloyIngred.get(c).metalType != null) {
                        currenttip.add(
                            "\u00B7 "
                                + TFC_Core.translate(
                                    "gui.metal." + currentAlloy.alloyIngred.get(c).metalType.name.replace(" ", ""))
                                + " : "
                                + m
                                + "%");
                    }
