...
public class BlockCustomCactus extends Block implements IPlantable {
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4) {
        ...
        return AxisAlignedBB
            .getBoundingBox(par2 + var5, par3, par4 + var5, par2 + 1 - var5, par3 + 1 - var5, par4 + 1 - var5);
    }
    ...
    public boolean canBlockStay(World par1World, int par2, int par3, int par4) {
        if (par1World.getBlock(par2 - 1, par3, par4)
            .getMaterial()
            .isSolid()) return false;
        else if (par1World.getBlock(par2 + 1, par3, par4)
            .getMaterial()
            .isSolid()) return false;
        else if (par1World.getBlock(par2, par3, par4 - 1)
            .getMaterial()
            .isSolid()) return false;
        else if (par1World.getBlock(par2, par3, par4 + 1)
            .getMaterial()
            .isSolid()) return false;
        else return canSustainPlant(par1World, par2, par3 - 1, par4, ForgeDirection.UP, this);
    }
