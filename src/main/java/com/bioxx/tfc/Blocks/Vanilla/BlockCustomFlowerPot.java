...
public class BlockCustomFlowerPot extends BlockFlowerPot {
    ...
    private boolean validItem(Item item, int meta) {
        if (item instanceof ItemBlock) {
            ...
            // TFC Blocks
            if (block == TFCBlocks.cactus || block == TFCBlocks.flora
                || block == TFCBlocks.flowers
                || block == TFCBlocks.flowers2
                || block == TFCBlocks.fungi
                || block == TFCBlocks.sapling
                || block == TFCBlocks.sapling2
                || block == TFCBlocks.tallGrass && meta == 1 /* Fern */) return true;
            ...
            if (block == Blocks.yellow_flower || block == Blocks.red_flower
                ...
                || block == Blocks.tallgrass && meta == 2 /* Fern */) return true;
        }
