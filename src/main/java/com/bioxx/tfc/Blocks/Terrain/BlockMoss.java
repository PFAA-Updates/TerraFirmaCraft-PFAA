...
public class BlockMoss extends BlockTerra {
    ...
    private boolean canBePlacedOn(Block block) {
        ...
        else return block.renderAsNormalBlock() && block.getMaterial()
            .blocksMovement();
    }
    ...
    private boolean canVineStay(World par1World, int par2, int par3, int par4) {
        ...
        if (l > 0) {
            for (int j1 = 0; j1 <= 3; ++j1) {
                ...
                if ((l & k1) != 0
                    && !this.canBePlacedOn(
                        par1World.getBlock(par2 + Direction.offsetX[j1], par3, par4 + Direction.offsetZ[j1]))
                    && (par1World.getBlock(par2, par3 + 1, par4) != this
                        || (par1World.getBlockMetadata(par2, par3 + 1, par4) & k1) == 0))
                    i1 &= ~k1;
            }
        }
        ...
        if (i1 == 0 && !this.canBePlacedOn(par1World.getBlock(par2, par3 + 1, par4))) {
            ...
            if (i1 != l) par1World.setBlockMetadataWithNotify(par2, par3, par4, i1, 2);
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        if (!world.isRemote && world.rand.nextInt(4) == 0) {
            ...
            label138: for (i1 = x - b0; i1 <= x + b0; ++i1) {
            ...
            if (j1 == 1 && y < 255 && world.isAirBlock(x, y + 1, z)) {
                ...
                if (l1 > 0) {
                    for (i2 = 0; i2 <= 3; ++i2) {
                        if (!this
                            .canBePlacedOn(world.getBlock(x + Direction.offsetX[i2], y + 1, z + Direction.offsetZ[i2])))
                            l1 &= ~(1 << i2);
                    }

                    if (l1 > 0) world.setBlock(x, y + 1, z, this, l1, 2);
                }
            } else {
                int j2;
                if (j1 >= 2 && j1 <= 5 && (i1 & 1 << k1) == 0) {
                    ...
                    if (!block.isAir(world, x + Direction.offsetX[k1], y, z + Direction.offsetZ[k1])) {
                        ...
                        if ((i1 & 1 << i2) != 0 && this.canBePlacedOn(
                            world.getBlock(
                        ...
                        else if ((i1 & 1 << j2) != 0 && this.canBePlacedOn(
                            world.getBlock(
                                x + Direction.offsetX[k1] + Direction.offsetX[j2],
                                y,
                                z + Direction.offsetZ[k1] + Direction.offsetZ[j2])))
                            ...
                            && world.isAirBlock(
                                ...
                                z + Direction.offsetZ[k1] + Direction.offsetZ[i2])
                            && this
                                .canBePlacedOn(world.getBlock(x + Direction.offsetX[i2], y, z + Direction.offsetZ[i2])))
                            world.setBlock(
                                x + Direction.offsetX[k1] + Direction.offsetX[i2],
                                y,
                                z + Direction.offsetZ[k1] + Direction.offsetZ[i2],
                            ...
                            && world.isAirBlock(
                                ...
                                z + Direction.offsetZ[k1] + Direction.offsetZ[j2])
                            && this
                                .canBePlacedOn(world.getBlock(x + Direction.offsetX[j2], y, z + Direction.offsetZ[j2])))
                            world.setBlock(
                                x + Direction.offsetX[k1] + Direction.offsetX[j2],
                                y,
                                z + Direction.offsetZ[k1] + Direction.offsetZ[j2],
                            ...
                            .canBePlacedOn(world.getBlock(x + Direction.offsetX[k1], y + 1, z + Direction.offsetZ[k1])))
                    ...
                    if (block.isAir(world, x, y - 1, z)) {
                        ...
                        if (i2 > 0) world.setBlock(x, y - 1, z, this, i2, 2);
                    } else if (block == this) {
                        i2 = world.rand.nextInt(16) & i1;
                        j2 = world.getBlockMetadata(x, y - 1, z);
                        if (j2 != (j2 | i2)) world.setBlockMetadataWithNotify(x, y - 1, z, j2 | i2, 2);
                    }
                }
            }
        }
