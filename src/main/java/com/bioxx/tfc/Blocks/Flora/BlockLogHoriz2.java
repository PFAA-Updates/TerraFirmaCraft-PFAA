...
public class BlockLogHoriz2 extends BlockLogHoriz {
    ...
    public IIcon getIcon(int side, int meta) {
        ...
        if (meta >= ((BlockLogNatural2) TFCBlocks.logNatural2).sideIcons.length) meta = 0;

        if (dir == 0) {
            if (side == 0 || side == 1) return ((BlockLogNatural2) TFCBlocks.logNatural2).sideIcons[meta];
            else if (side == 2 || side == 3) return ((BlockLogNatural2) TFCBlocks.logNatural2).innerIcons[meta];
            else return ((BlockLogNatural2) TFCBlocks.logNatural2).rotatedSideIcons[meta];
        } else {
            if (side == 0 || side == 1 || side == 2 || side == 3)
                return ((BlockLogNatural2) TFCBlocks.logNatural2).rotatedSideIcons[meta];
            else return ((BlockLogNatural2) TFCBlocks.logNatural2).innerIcons[meta];
        }
    }
