...
public class BlockStand extends BlockTerraContainer implements IMultipleBlock, IEquipable {
     ...
     * {
     * return par1 == 1 ? this.blockIndexInTexture - 1 : (par1 == 0 ? this.blockIndexInTexture - 1 : (par1 == 3 ?
     * this.blockIndexInTexture + 1 : this.blockIndexInTexture));
     * }
     */
