...
public class BlockForge extends BlockTerraContainer {
    ...
    /**
     * Displays a flat icon image for an ItemStack containing the block, instead of a render. Using primarily for WAILA
     * HUD.
     */
    @Override
