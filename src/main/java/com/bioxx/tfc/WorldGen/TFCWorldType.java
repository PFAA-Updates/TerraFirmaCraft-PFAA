...
public class TFCWorldType extends WorldType {
    ...
    private static final TFCBiome[] BIOMES_DEFAULT = new TFCBiome[] { TFCBiome.OCEAN, TFCBiome.HIGH_HILLS,
        TFCBiome.PLAINS, TFCBiome.HIGH_PLAINS, TFCBiome.SWAMPLAND, TFCBiome.ROLLING_HILLS, TFCBiome.MOUNTAINS, };
    ...
    public TFCBiome[] getBiomesForWorldType() {
        if (this == TFCWorldType.defaultWorldType) return BIOMES_DEFAULT.clone();
        else if (this == TFCWorldType.flatWorldType) return BIOMES_FLAT.clone();
