    ...
    public int[] getInts(int par1, int par2, int xMax, int zMax) {
        ...
        for (int z = 0; z < zMax; ++z) {
            for (int x = 0; x < xMax; ++x) {
                ...
                if (this.nextInt(var18++) == 0) outID = var13;

                if (this.nextInt(var18++) == 0) outID = var14;

                if (this.nextInt(var18++) == 0) outID = var15;

                if (this.nextInt(var18++) == 0) outID = var16;

                if (this.nextInt(2) == 0) outCache[x + z * xMax] = outID;
                else outCache[x + z * xMax] = thisID;
