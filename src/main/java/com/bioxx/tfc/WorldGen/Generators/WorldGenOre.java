...
public class WorldGenOre implements IWorldGenerator {
        ...
        while (iter.hasNext()) {
            ...
            if (osd.type == 0) {
                ...
                if (osd.size == 0) oreSmallVein(
                    ...
                    osd.vDensity,
                    osd.hDensity);
                else if (osd.size == 1) oreMediumVein(
                    osd.block,
                    osd.meta,
                    osd.base,
                    osd.rarity,
                    ...
                    osd.vDensity,
                    osd.hDensity);
                else if (osd.size == 2) oreLargeVein(
                    osd.block,
                    osd.meta,
                    osd.base,
                    osd.rarity,
    ...
    private void oreSmallVein(Block block, int meta, Map<Block, List<Integer>> baseRocks, int rarity, int min, int max,
    ...
    private void oreMediumVein(Block block, int meta, Map<Block, List<Integer>> baseRocks, int rarity, int min, int max,
        int vDensity, int hDensity) {
        createOreVein(
            block,
            meta,
    ...
    private void oreLargeVein(Block block, int meta, Map<Block, List<Integer>> baseRocks, int rarity, int min, int max,
        int vDensity, int hDensity) {
        createOreVein(
            block,
            meta,
    ...
    private void oreSmall(Block block, int meta, Map<Block, List<Integer>> baseRocks, int rarity, int min, int max,
        int vDensity, int hDensity) {
        createOre(
            block,
            meta,
    ...
    private void oreMedium(Block block, int meta, Map<Block, List<Integer>> baseRocks, int rarity, int min, int max,
        int vDensity, int hDensity) {
        createOre(
            block,
            meta,
    ...
    private void oreLarge(Block block, int meta, Map<Block, List<Integer>> baseRocks, int rarity, int min, int max,
        int vDensity, int hDensity) {
        createOre(
            block,
            meta,
    ...
    private static void createOre(Block block, int j, Map<Block, List<Integer>> layers, int rarity, int veinSize,
        int veinAmount, int height, int diameter, int vDensity, int hDensity, World world, Random rand, int chunkX,
        int chunkZ, int min, int max) {
                ...
                for (int metadata : layers.get(b)) {
                    ...
                    if (rockLayer1.block == b && (rockLayer1.data2 == metadata || metadata == -1)
                        ...
                        new WorldGenMinable(
                            ...
                            hDensity,
                            false,
                            grade).generate(world, rand, chunkX, chunkZ, min, max);
                    }
                }
            }
        }
