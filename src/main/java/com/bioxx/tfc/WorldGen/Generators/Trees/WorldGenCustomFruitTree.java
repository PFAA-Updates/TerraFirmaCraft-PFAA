...
public class WorldGenCustomFruitTree extends WorldGenerator {
    ...
    public boolean generate(World world, Random random, int i, int j, int k) {
        ...
        if (world.isAirBlock(i, j, k) && j < 250 && temp > 10 && temp < 25 && rain >= 500) gen(world, random, i, j, k);
        return true;
    }
        ...
        if (world.isAirBlock(i, j + 1, k)) {
            ...
            if (world.isAirBlock(i, j + 2, k)) {
                ...
                if (world.isAirBlock(i, j + 3, k) || world.getBlock(i, j + 3, k) == leavesBlock) {
                    ...
                    if (world.isAirBlock(i, j + 4, k)) world.setBlock(i, j + 4, k, leavesBlock, metaId & 7, 0x2);
                }
            }
        }
    }
