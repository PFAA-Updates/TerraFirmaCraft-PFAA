...
public class WorldGenSaplings {
    ...
    public void generate(World world, Random random, int xCoord, int yCoord, int zCoord) {
        ...
        if (hasSpaceToGrow) {
            ...
            float evt = TFC_Climate.getCacheManager(world)
                .getEVTLayerAt(xCoord, zCoord).floatdata1;

            if (treeType0 < 0 || treeType0 > 15) treeType0 = TFC_Climate.getTreeLayer(world, xCoord, yCoord, zCoord, 2);
            if (treeType1 < 0 || treeType1 > 15) treeType1 = TFC_Climate.getTreeLayer(world, xCoord, yCoord, zCoord, 0);
            if (treeType2 < 0 || treeType2 > 15) treeType2 = TFC_Climate.getTreeLayer(world, xCoord, yCoord, zCoord, 1);
             ...
             */
            if (zCoord > 14500 || zCoord < -14500) treeType2 = 8;

            boolean canSpawnTemp0 = false, canSpawnTemp1 = false, canSpawnTemp2 = false, canSpawnRain0 = false,
                canSpawnRain1 = false, canSpawnRain2 = false, canSpawnEVT0 = false, canSpawnEVT1 = false,
                canSpawnEVT2 = false;
