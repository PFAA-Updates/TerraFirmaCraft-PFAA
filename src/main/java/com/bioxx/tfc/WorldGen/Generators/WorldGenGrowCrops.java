...
public class WorldGenGrowCrops implements IWorldGenerator {
        ...
        for (int c = 0; c < numToGen; c++) {
            ...
            if (crop != null) {
                ...
                if (temp > crop.minAliveTemp && month > 0 && month <= 6) {
                    ...
                    if (TFCBlocks.crops.canBlockStay(world, i, j, k)
                        && (b.isAir(world, i, j, k) || b == TFCBlocks.tallGrass)) {
    ...
    @Override
    public void generate(Random par2Random, int x, int z, World world, IChunkProvider chunkGenerator,
