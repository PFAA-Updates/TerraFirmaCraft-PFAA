...
public class WorldGenCustomReed extends WorldGenerator {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        for (int var6 = 0; var6 < 20; ++var6) {
            ...
            if (par1World.isAirBlock(var7, par4, var9) && (par1World.getBlock(var7 - 1, par4 - 1, var9)
                .getMaterial() == Material.water
                || par1World.getBlock(var7 + 1, par4 - 1, var9)
                    .getMaterial() == Material.water
                || par1World.getBlock(var7, par4 - 1, var9 - 1)
                    .getMaterial() == Material.water
                || par1World.getBlock(var7, par4 - 1, var9 + 1)
                    .getMaterial() == Material.water)) {
