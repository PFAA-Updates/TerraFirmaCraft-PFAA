                    ...
                    for (xCoord = var55; !var58 && xCoord < var36; ++xCoord) {
                        for (zCoord = var56; !var58 && zCoord < var40; ++zCoord) {
                            for (int y = yCoord + 1; !var58 && y >= var57 - 1; --y) {
                                ...
                                if (y >= 0 && y < 256) {
                                    if (idArray[index] == TFCBlocks.saltWaterStationary
                                        || idArray[index] == TFCBlocks.freshWaterStationary) var58 = true;
                                    if (y != var57 - 1 && xCoord != var55
                                        && xCoord != var36 - 1
                                        && zCoord != var56
                                        && zCoord != var40 - 1) y = var57;
                                }
                            }
                        }
                    }
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D) {
                                            ...
                                            if (TFC_Core.isSoil(idArray[index])
                                                ...
                                                if (TFC_Core.isSoilOrGravel(idArray[index + 1])) {
                                                    for (int upCount = 1; TFC_Core
                                                        .isSoilOrGravel(idArray[index + upCount]); upCount++) {
                                                        idArray[index + upCount] = Blocks.air;
                                                    }
                                                }

                                                if (var50 < 10 && TFC_Climate
                                                    .getStability(this.worldObj, (int) worldX, (int) worldZ) == 1) {
