...
public class TFCProviderHell extends TFCProvider {
    ...
    protected void registerWorldChunkManager() {
        ...
        if (worldObj.isRemote) TFC_Climate.worldPair.put(worldObj, new WorldCacheManager(worldObj));
        else TFC_Climate.worldPair.put(worldObj, new WorldCacheManager(worldObj));
    }
