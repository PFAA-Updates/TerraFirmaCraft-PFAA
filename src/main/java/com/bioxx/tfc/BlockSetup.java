...
public class BlockSetup extends TFCBlocks {
    ...
    public static void loadBlocks() {
         ...
         * (new
         * BlockCustomSnow()).setHardness(0.1F).setStepSound(Block.soundTypeSnow).setBlockName("snow").setLightOpacity(1
        ...
        peatGrass = new BlockPeatGrass().setHardness(3F)
            .setStepSound(Block.soundTypeGrass)
            .setBlockName("PeatGrass");
        dryGrass = new BlockDryGrass(0).setHardness(3F)
            .setStepSound(Block.soundTypeGrass)
            .setBlockName("DryGrass");
        ...
        worldItem = new BlockWorldItem().setHardness(0.05F)
            .setResistance(1F)
            .setBlockName("LooseRock");
        sulfur = new BlockSulfur(Material.rock).setBlockName("Sulfur")
            .setHardness(0.5F)
            .setResistance(1F);

        logPile = new BlockLogPile().setHardness(10F)
            .setResistance(1F)
            .setBlockName("LogPile");
        woodSupportV = new BlockWoodSupport(Material.wood).setBlockName("WoodSupportV")
            .setHardness(0.5F)
            .setResistance(1F);
        woodSupportH = new BlockWoodSupport(Material.wood).setBlockName("WoodSupportH")
            .setHardness(0.5F)
            .setResistance(1F);
        woodSupportV2 = new BlockWoodSupport2(Material.wood).setBlockName("WoodSupportV2")
            .setHardness(0.5F)
            .setResistance(1F);
        woodSupportH2 = new BlockWoodSupport2(Material.wood).setBlockName("WoodSupportH2")
            .setHardness(0.5F)
            .setResistance(1F);
        ...
        fruitTreeWood = new BlockFruitWood().setBlockName("fruitTreeWood")
            .setHardness(5.5F)
            .setResistance(2F);
        fruitTreeLeaves = new BlockFruitLeaves(0).setBlockName("fruitTreeLeaves")
            .setHardness(0.5F)
            .setResistance(1F)
            .setStepSound(Block.soundTypeGrass);
        fruitTreeLeaves2 = new BlockFruitLeaves(8).setBlockName("fruitTreeLeaves2")
            .setHardness(0.5F)
            .setResistance(1F)
            .setStepSound(Block.soundTypeGrass);
        ...
        firepit = new BlockFirepit().setBlockName("Firepit")
            .setHardness(1)
            .setLightLevel(0F);
        bellows = new BlockBellows(Material.wood).setBlockName("Bellows")
            .setHardness(2);
        forge = new BlockForge().setBlockName("Forge")
            .setHardness(20)
            .setLightLevel(0F);
        anvil = new BlockAnvil().setBlockName("Anvil")
            .setHardness(3)
            .setResistance(100F);
        anvil2 = new BlockAnvil(8).setBlockName("Anvil2")
            .setHardness(3)
            .setResistance(100F);

        molten = new BlockMolten().setBlockName("Molten")
            .setHardness(20);
        blastFurnace = new BlockBlastFurnace().setBlockName("BlastFurnace")
            .setHardness(20)
            .setLightLevel(0F);
        bloomery = new BlockEarlyBloomery().setBlockName("EarlyBloomery")
            .setHardness(20)
            .setLightLevel(0F);
        bloom = new BlockBloom().setBlockName("Bloom")
            .setHardness(20)
            .setLightLevel(0F);
        sluice = new BlockSluice().setBlockName("Sluice")
            .setHardness(2F)
            .setResistance(20F);

        stoneStairs = new BlockStair(Material.rock).setBlockName("stoneStairs")
            .setHardness(10);
        stoneSlabs = new BlockSlab().setBlockName("stoneSlabs")
            .setHardness(10);
        stoneStalac = new BlockStalactite().setBlockName("stoneStalac")
            .setHardness(5);

        charcoal = new BlockCharcoal().setHardness(3F)
            .setResistance(10F)
            .setBlockName("Charcoal");

        detailed = new BlockDetailed().setBlockName("StoneDetailed")
            .setHardness(10);
        ...
        logNatural2 = new BlockLogNatural2().setHardness(50.0F)
            .setStepSound(Block.soundTypeWood)
            .setBlockName("log2");
        woodVert = new BlockLogVert().setBlockName("WoodVert")
            .setHardness(20)
            .setResistance(15F)
            .setStepSound(Block.soundTypeWood);
        woodVert2 = new BlockLogVert2().setBlockName("WoodVert2")
            .setHardness(20)
            .setResistance(15F)
            .setStepSound(Block.soundTypeWood);
        woodHoriz = new BlockLogHoriz(0).setBlockName("WoodHoriz")
            .setHardness(20)
            .setResistance(15F)
            .setStepSound(Block.soundTypeWood);
        woodHoriz2 = new BlockLogHoriz(8).setBlockName("WoodHoriz2")
            .setHardness(20)
            .setResistance(15F)
            .setStepSound(Block.soundTypeWood);
        woodHoriz3 = new BlockLogHoriz2(0).setBlockName("WoodHoriz3")
            .setHardness(20)
            .setResistance(15F)
            .setStepSound(Block.soundTypeWood);
        // Use 8 instead of 0 if Global.WOOD_ALL.length > 24
        woodHoriz4 = new BlockLogHoriz2(/* 8 */0).setBlockName("WoodHoriz4")
            .setHardness(20)
            .setResistance(15F)
            .setStepSound(Block.soundTypeWood);

        toolRack = new BlockToolRack().setHardness(3F)
            .setBlockName("Toolrack");
        spawnMeter = new BlockSpawnMeter().setHardness(3F)
            .setBlockName("SpawnMeter");
        foodPrep = new BlockFoodPrep().setHardness(1F)
            .setBlockName("FoodPrep");
        ...
        barrel = new BlockBarrel().setBlockName("Barrel")
            .setHardness(2);
        loom = new BlockLoom().setBlockName("Loom")
            .setHardness(2);
        thatch = new BlockThatch().setBlockName("Thatch")
            .setHardness(1)
            .setStepSound(Block.soundTypeGrass)
            .setCreativeTab(TFCTabs.TFC_BUILDING);
        moss = new BlockMoss().setBlockName("Moss")
            .setHardness(1)
            .setStepSound(Block.soundTypeGrass);

        flora = new BlockFlora().setBlockName("Flora")
            .setHardness(0.1f)
            .setStepSound(Block.soundTypeGrass);
        pottery = new BlockPottery().setBlockName("Pottery")
            .setHardness(1.0f);

        crucible = new BlockCrucible().setBlockName("Crucible")
            .setHardness(4.0f);

        nestBox = new BlockNestBox().setBlockName("NestBox")
            .setHardness(1);

        fence = new BlockTFCFence("Fence", Material.wood).setBlockName("FenceTFC")
            .setHardness(2);
        fenceGate = new BlockCustomFenceGate().setBlockName("FenceGateTFC")
            .setHardness(2);
        fence2 = new BlockTFCFence2("Fence2", Material.wood).setBlockName("FenceTFC")
            .setHardness(2);
        fenceGate2 = new BlockCustomFenceGate2().setBlockName("FenceGateTFC")
            .setHardness(2);
        strawHideBed = new BlockBed().setBlockName("StrawHideBed")
            .setHardness(1)
            .setCreativeTab(null);
        armorStand = new BlockStand().setBlockName("ArmourStand")
            .setHardness(2);
        armorStand2 = new BlockStand2().setBlockName("ArmourStand")
            .setHardness(2);

        berryBush = new BlockBerryBush().setBlockName("BerryBush")
            .setHardness(0.3f)
            .setStepSound(Block.soundTypeGrass);
        crops = new BlockCrop().setBlockName("crops")
            .setHardness(0.3F)
            .setStepSound(Block.soundTypeGrass);
        lilyPad = new BlockCustomLilyPad().setHardness(0.0F)
            .setStepSound(Block.soundTypeGrass)
            .setBlockName("LilyPad")
            .setBlockTextureName("waterlily");
        flowers = new BlockFlower().setHardness(0.0F)
            .setStepSound(Block.soundTypeGrass)
            .setBlockName("Flowers");
        flowers2 = new BlockFlower2().setHardness(0.0F)
            .setStepSound(Block.soundTypeGrass)
            .setBlockName("Flowers2");
        ...
        saltWaterStationary = new BlockLiquidStatic(TFCFluids.SALTWATER, Material.water, saltWater).setHardness(100.0F)
            .setLightOpacity(3)
            .setBlockName("SaltWaterStationary");
        ...
        freshWaterStationary = new BlockLiquidStatic(TFCFluids.FRESHWATER, Material.water, freshWater)
            .setHardness(100.0F)
            .setLightOpacity(3)
            .setBlockName("FreshWaterStationary");
        ...
        hotWaterStationary = new BlockHotWaterStatic(TFCFluids.HOTWATER, Material.water, hotWater).setHardness(100.0F)
            .setLightOpacity(3)
            .setBlockName("HotWaterStationary");
        ...
        waterPlant = new BlockWaterPlant(0).setBlockName("SeaGrassStill")
            .setHardness(0.5f)
            .setStepSound(Block.soundTypeGravel);

        fireBrick = new BlockFireBrick().setBlockName("FireBrick")
            .setHardness(8);
        metalSheet = new BlockMetalSheet().setBlockName("MetalSheet")
            .setHardness(80);
        leatherRack = new BlockLeatherRack().setBlockName("LeatherRack")
            .setHardness(1);
