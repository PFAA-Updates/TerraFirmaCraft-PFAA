...
public class EntityAIAvoidEntityTFC extends EntityAIBase {
    ...
    public EntityAIAvoidEntityTFC(EntityCreature par1EntityCreature, Class par2Class, float par3, double par4,
        double par6) {
    ...
    public boolean shouldExecute() {
        if (this.targetEntityClass == EntityPlayer.class) {
            if (this.theEntity instanceof IAnimal
                && ((IAnimal) theEntity).checkFamiliarity(InteractionEnum.TOLERATEPLAYER, null)) {
                return false;
            }
        ...
        if (vec3 == null) return false;
            ...
            < this.closestLivingEntity.getDistanceSqToEntity(this.theEntity)) return false;
        else {
    ...
    public void updateTask() {
        if (this.theEntity.getDistanceSqToEntity(this.closestLivingEntity) < 49.0D) this.theEntity.getNavigator()
            .setSpeed(this.nearSpeed);
        else this.theEntity.getNavigator()
