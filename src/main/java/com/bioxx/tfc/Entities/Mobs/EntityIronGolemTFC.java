...
public class EntityIronGolemTFC extends EntityIronGolem {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.maxHealth)
            .setBaseValue(TFC_MobData.IRON_GOLEM_HEALTH);// MaxHealth
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.motionX * this.motionX + this.motionZ * this.motionZ > 2.500000277905201E-7D
            ...
            if (block.getMaterial() != Material.air) this.worldObj.spawnParticle(
                "tilecrack_" + Block.getIdFromBlock(block) + "_" + meta,
    ...
    public boolean attackEntityAsMob(Entity entity) {
        ...
        boolean var2 = entity.attackEntityFrom(
            DamageSource.causeMobDamage(this),
            TFC_MobData.IRON_GOLEM_DAMAGE + this.rand.nextInt(150));

        if (var2) entity.motionY += 0.4000000059604645D;
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        for (int l = 0; l < k; ++l) this.dropItem(TFCItems.wroughtIronIngot, 1);
    }
}
