...
public class EntityDeer extends EntityAnimal implements IAnimal {
    ...
    protected void dropFewItems(boolean par1, int par2) {
        ...
        this.entityDropItem(
            new ItemStack(TFCItems.hide, 1, Math.max(0, Math.min(2, (int) (ageMod * sizeMod * 1.84)))),
            0);
    ...
    protected String getLivingSound() {
        if (getGender() == GenderEnum.MALE && isAdult() && worldObj.rand.nextInt(100) < 5) return TFC_Sounds.DEERCRY;
