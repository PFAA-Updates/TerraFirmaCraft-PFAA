...
public class ServerOverrides {
    ...
    static public boolean canPlayerMove(EntityLivingBase entity) {
        double ref = entity.getEntityAttribute(SharedMonsterAttributes.movementSpeed)
            .getAttributeValue();
        if (ref > 0.001) return true;
    ...
    public static int isValidSurface(Block b) {
        if (TFC_Core.isFence(b) || b != null && b.getRenderType() == 11) return 11;
