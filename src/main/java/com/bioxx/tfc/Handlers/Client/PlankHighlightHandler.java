...
public class PlankHighlightHandler {
    ...
    public void drawBlockHighlightEvent(DrawBlockHighlightEvent evt) {
        ...
        if (evt.currentItem != null && evt.currentItem.getItem() instanceof ItemPlank) {
            ...
            // ForgeHooksClient.bindTexture("/bioxx/woodoverlay.png",
            // ModLoader.getMinecraftInstance().renderEngine.getTexture("/bioxx/woodoverlay.png"));
            ...
            boolean isConstruct = world.getBlock(evt.target.blockX, evt.target.blockY, evt.target.blockZ)
                == TFCBlocks.woodConstruct;
