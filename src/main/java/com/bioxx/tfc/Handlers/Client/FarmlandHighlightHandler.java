...
public class FarmlandHighlightHandler {
    ...
    public void drawBlockHighlightEvent(DrawBlockHighlightEvent evt) {
        ...
        if (evt.currentItem != null && evt.currentItem.getItem() != TFCItems.igInHoe
        ...
        if (evt.currentItem != null && evt.currentItem.getItem() instanceof ItemCustomHoe
            ...
            if (TFC_Core.getSkillStats(evt.player) != null) {
                SkillRank sr = TFC_Core.getSkillStats(evt.player)
                    .getSkillRank(Global.SKILL_AGRICULTURE);
                if (sr != SkillRank.Expert && sr != SkillRank.Master) return;
            }
            ...
            if (b == TFCBlocks.crops
                && (world.getBlock(evt.target.blockX, evt.target.blockY - 1, evt.target.blockZ) == TFCBlocks.tilledSoil
                    || world.getBlock(evt.target.blockX, evt.target.blockY - 1, evt.target.blockZ)
                        == TFCBlocks.tilledSoil2)) {
                b = TFCBlocks.tilledSoil;
                crop = 1;
            }

            if (b == TFCBlocks.tilledSoil || b == TFCBlocks.tilledSoil2) {
                TEFarmland te = (TEFarmland) world
                    .getTileEntity(evt.target.blockX, evt.target.blockY - crop, evt.target.blockZ);
                ...
                GL11.glColor4ub(
                    TFCOptions.cropFertilizerColor[0],
                    TFCOptions.cropFertilizerColor[1],
                    TFCOptions.cropFertilizerColor[2],
                    TFCOptions.cropFertilizerColor[3]);
                drawBox(
                    AxisAlignedBB
                        .getBoundingBox(
                ...
                GL11.glColor4ub(
                    TFCOptions.cropNutrientAColor[0],
                    TFCOptions.cropNutrientAColor[1],
                    TFCOptions.cropNutrientAColor[2],
                    TFCOptions.cropNutrientAColor[3]);
                drawBox(
                    AxisAlignedBB
                        .getBoundingBox(
                            evt.target.blockX + offset,
                ...
                GL11.glColor4ub(
                    TFCOptions.cropNutrientBColor[0],
                    TFCOptions.cropNutrientBColor[1],
                    TFCOptions.cropNutrientBColor[2],
                    TFCOptions.cropNutrientBColor[3]);
                drawBox(
                    AxisAlignedBB
                        .getBoundingBox(
                            evt.target.blockX + offset,
                ...
                GL11.glColor4ub(
                    TFCOptions.cropNutrientCColor[0],
                    TFCOptions.cropNutrientCColor[1],
                    TFCOptions.cropNutrientCColor[2],
                    TFCOptions.cropNutrientCColor[3]);
                drawBox(
                    AxisAlignedBB
                        .getBoundingBox(
                            evt.target.blockX + offset,
            ...
            if (b == TFCBlocks.tilledSoil || b == TFCBlocks.tilledSoil2) {
                boolean water = com.bioxx.tfc.Blocks.BlockFarmland
                    .isFreshWaterNearby(world, evt.target.blockX, evt.target.blockY - crop, evt.target.blockZ);
            ...
            if (b == TFCBlocks.crops
                ...
                CropIndex index = CropManager.getInstance()
                    .getCropFromId(te.cropId);
                boolean fullyGrown = index instanceof CropIndexPepper ? te.growth >= index.numGrowthStages - 1
                    : te.growth >= index.numGrowthStages;
