...
public class InitClientWorldPacket extends AbstractPacket {
    ...
    public InitClientWorldPacket(EntityPlayer p) {
        ...
        if (p.getEntityData()
            .hasKey("craftingTable")) this.craftingTable = true;
        this.playerSkills = TFC_Core.getSkillStats(p);
        this.chiselMode = PlayerManagerTFC.getInstance()
            .getPlayerInfoFromPlayer(p).chiselMode;
    }
    ...
    public void handleClientSide(EntityPlayer player) {
        ...
        if (this.craftingTable) {
            player.getEntityData()
                .setBoolean("craftingTable", this.craftingTable);
        ...
        PlayerManagerTFC.getInstance().players.add(new PlayerInfo(player.getCommandSenderName(), player.getUniqueID()));

        PlayerManagerTFC.getInstance()
            .getClientPlayer()
            .setChiselMode(this.chiselMode);
