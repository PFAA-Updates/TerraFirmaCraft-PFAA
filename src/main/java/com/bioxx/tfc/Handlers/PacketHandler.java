...
public class PacketHandler// implements IPacketHandler, IConnectionHandler
{
    ...
    // ((ContainerSpecialCrafting)player.openContainer).craftMatrix.setInventorySlotContents(index,
    // PlayerManagerTFC.getInstance().getPlayerInfoFromPlayer(player).specialCraftingTypeAlternate);
