...
public class TFCASMLoadingPlugin implements IFMLLoadingPlugin {
    ...
    public String[] getASMTransformerClass() {
        return new String[] { TF_EntityRenderer.class.getName(), TF_RenderGlobal.class.getName(),
            TF_EntityLeashKnot.class.getName(), TF_EntityPlayerMP.class.getName(), TF_EntityPlayer.class.getName() };
    }
